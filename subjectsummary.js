...
if (localStorage.getItem('subject1') == 1) {
  document.getElementById('subjectb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('subject1') == 0) {
  document.getElementById('subjectb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('subject2') == 1) {
    document.getElementById('subjectb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('subject2') == 0) {
    document.getElementById('subjectb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('subject3') == 1) {
  document.getElementById('subjectb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('subject3') == 0) {
  document.getElementById('subjectb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('subject4') == 1) {
  document.getElementById('subjectb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('subject4') == 0) {
  document.getElementById('subjectb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('subject5') == 1) {
    document.getElementById('subjectb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('subject5') == 0) {
    document.getElementById('subjectb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('subject6') == 1) {
  document.getElementById('subjectb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('subject6') == 0) {
  document.getElementById('subjectb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('subject7') == 1) {
  document.getElementById('subjectb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('subject7') == 0) {
  document.getElementById('subjectb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('subject8') == 1) {
  document.getElementById('subjectb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('subject8') == 0) {
  document.getElementById('subjectb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('subject9') == 1) {
  document.getElementById('subjectb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('subject9') == 0) {
  document.getElementById('subjectb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('subject10') == 1) {
  document.getElementById('subjectb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('subject10') == 0) {
  document.getElementById('subjectb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
