...
if (localStorage.getItem('psysenper1') == 1) {
  document.getElementById('psysenperb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('psysenper1') == 0) {
  document.getElementById('psysenperb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('psysenper2') == 1) {
    document.getElementById('psysenperb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('psysenper2') == 0) {
    document.getElementById('psysenperb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('psysenper3') == 1) {
  document.getElementById('psysenperb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('psysenper3') == 0) {
  document.getElementById('psysenperb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('psysenper4') == 1) {
  document.getElementById('psysenperb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('psysenper4') == 0) {
  document.getElementById('psysenperb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('psysenper5') == 1) {
    document.getElementById('psysenperb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('psysenper5') == 0) {
    document.getElementById('psysenperb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('psysenper6') == 1) {
  document.getElementById('psysenperb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('psysenper6') == 0) {
  document.getElementById('psysenperb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('psysenper7') == 1) {
  document.getElementById('psysenperb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('psysenper7') == 0) {
  document.getElementById('psysenperb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('psysenper8') == 1) {
  document.getElementById('psysenperb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('psysenper8') == 0) {
  document.getElementById('psysenperb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('psysenper9') == 1) {
  document.getElementById('psysenperb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('psysenper9') == 0) {
  document.getElementById('psysenperb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('psysenper10') == 1) {
  document.getElementById('psysenperb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('psysenper10') == 0) {
  document.getElementById('psysenperb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
