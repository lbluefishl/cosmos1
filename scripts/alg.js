...
if (document.getElementById('sa-alg-1') != null) {
 alg1But.onclick = function() {
    if (document.getElementById('o-alg-11').checked) {
      document.getElementById('b-alg-11').style.border = '3px solid limegreen'
      document.getElementById('r-alg-11').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-12').checked) {
      document.getElementById('b-alg-12').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-13').checked) {
      document.getElementById('b-alg-13').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-14').checked) {
      document.getElementById('b-alg-14').style.border = '3px solid red'
...
if (document.getElementById('sa-alg-2') != null) {
  alg2But.onclick = function() {
    if (document.getElementById('o-alg-21').checked) {
      document.getElementById('b-alg-21').style.border = '3px solid red'
      document.getElementById('r-alg-21').style.color = 'red'
      document.getElementById('r-alg-21').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-23').style.border = '3px solid limegreen'
      document.getElementById('r-alg-23').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-22').checked) {
      document.getElementById('b-alg-22').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-24').checked) {
      document.getElementById('b-alg-24').style.border = '3px solid red'
...
if (document.getElementById('sa-alg-3') != null) {
  alg3But.onclick = function() {
    if (document.getElementById('o-alg-31').checked) {
      document.getElementById('b-alg-31').style.border = '3px solid red'
      document.getElementById('r-alg-31').style.color = 'red'
      document.getElementById('r-alg-31').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-32').style.border = '3px solid limegreen'
      document.getElementById('r-alg-32').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-33').checked) {
      document.getElementById('b-alg-33').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-34').checked) {
      document.getElementById('b-alg-34').style.border = '3px solid red'
...
if (document.getElementById('sa-alg-4') != null) {
  alg4But.onclick = function() {
    if (document.getElementById('o-alg-41').checked) {
      document.getElementById('b-alg-41').style.border = '3px solid red'
      document.getElementById('r-alg-41').style.color = 'red'
      document.getElementById('r-alg-41').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-44').style.border = '3px solid limegreen'
      document.getElementById('r-alg-44').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-42').checked) {
      document.getElementById('b-alg-42').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-43').checked) {
      document.getElementById('b-alg-43').style.border = '3px solid red'
...
if (document.getElementById('sa-alg-5') != null) {
  alg5But.onclick = function() {
    if (document.getElementById('o-alg-51').checked) {
      document.getElementById('b-alg-51').style.border = '3px solid red'
      document.getElementById('r-alg-51').style.color = 'red'
      document.getElementById('r-alg-51').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-53').style.border = '3px solid limegreen'
      document.getElementById('r-alg-53').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-52').checked) {
      document.getElementById('b-alg-52').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-54').checked) {
      document.getElementById('b-alg-54').style.border = '3px solid red'
  ...
  alg6But.onclick = function() {
    if (document.getElementById('o-alg-61').checked) {
      document.getElementById('b-alg-61').style.border = '3px solid red'
      document.getElementById('r-alg-61').style.color = 'red'
      document.getElementById('r-alg-61').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-64').style.border = '3px solid limegreen'
      document.getElementById('r-alg-64').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-62').checked) {
      document.getElementById('b-alg-62').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-63').checked) {
      document.getElementById('b-alg-63').style.border = '3px solid red'
...
if (document.getElementById('sa-alg-7') != null) {
  alg7But.onclick = function() {
    if (document.getElementById('o-alg-71').checked) {
      document.getElementById('b-alg-71').style.border = '3px solid red'
      document.getElementById('r-alg-71').style.color = 'red'
      document.getElementById('r-alg-71').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-74').style.border = '3px solid limegreen'
      document.getElementById('r-alg-74').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-72').checked) {
      document.getElementById('b-alg-72').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-73').checked) {
      document.getElementById('b-alg-73').style.border = '3px solid red'
...
if (document.getElementById('sa-alg-8') != null) {
  alg8But.onclick = function() {
    if (document.getElementById('o-alg-81').checked) {
      document.getElementById('b-alg-81').style.border = '3px solid red'
      document.getElementById('r-alg-81').style.color = 'red'
      document.getElementById('r-alg-81').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-82').style.border = '3px solid limegreen'
      document.getElementById('r-alg-82').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-83').checked) {
      document.getElementById('b-alg-83').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-84').checked) {
      document.getElementById('b-alg-84').style.border = '3px solid red'
...
if (document.getElementById('sa-alg-9') != null) {
  alg9But.onclick = function() {
    if (document.getElementById('o-alg-91').checked) {
      document.getElementById('b-alg-91').style.border = '3px solid red'
      document.getElementById('r-alg-91').style.color = 'red'
      document.getElementById('r-alg-91').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-94').style.border = '3px solid limegreen'
      document.getElementById('r-alg-94').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-92').checked) {
      document.getElementById('b-alg-92').style.border = '3px solid red'
      document.getElementById('r-alg-92').style.color = 'red'
      document.getElementById('r-alg-92').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-94').style.border = '3px solid limegreen'
      document.getElementById('r-alg-94').style.color = 'limegreen'
      document.getElementById('r-alg-94').innerHTML = 'Correct!'
      document.getElementById('sa-alg-9').disabled = true;
    ...
    if (document.getElementById('o-alg-93').checked) {
      document.getElementById('b-alg-93').style.border = '3px solid red'
      document.getElementById('r-alg-93').style.color = 'red'
      document.getElementById('r-alg-93').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-94').style.border = '3px solid limegreen'
      document.getElementById('r-alg-94').style.color = 'limegreen'
      document.getElementById('r-alg-94').innerHTML = 'Correct!'
      document.getElementById('sa-alg-9').disabled = true;
...
if (document.getElementById('sa-alg-10') != null) {
  alg10But.onclick = function() {
    if (document.getElementById('o-alg-101').checked) {
      document.getElementById('b-alg-101').style.border = '3px solid red'
      document.getElementById('r-alg-101').style.color = 'red'
      document.getElementById('r-alg-101').innerHTML = 'Incorrect!'
      document.getElementById('b-alg-102').style.border = '3px solid limegreen'
      document.getElementById('r-alg-102').style.color = 'limegreen'
    ...
    if (document.getElementById('o-alg-103').checked) {
      document.getElementById('b-alg-103').style.border = '3px solid red'
    ...
    if (document.getElementById('o-alg-104').checked) {
      document.getElementById('b-alg-104').style.border = '3px solid red'
