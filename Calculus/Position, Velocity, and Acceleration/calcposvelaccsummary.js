...
if (localStorage.getItem('calcposvelacc1') == 1) {
  document.getElementById('calcposvelaccb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('calcposvelacc1') == 0) {
  document.getElementById('calcposvelaccb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('calcposvelacc2') == 1) {
    document.getElementById('calcposvelaccb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('calcposvelacc2') == 0) {
    document.getElementById('calcposvelaccb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('calcposvelacc3') == 1) {
  document.getElementById('calcposvelaccb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('calcposvelacc3') == 0) {
  document.getElementById('calcposvelaccb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('calcposvelacc4') == 1) {
  document.getElementById('calcposvelaccb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('calcposvelacc4') == 0) {
  document.getElementById('calcposvelaccb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('calcposvelacc5') == 1) {
    document.getElementById('calcposvelaccb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('calcposvelacc5') == 0) {
    document.getElementById('calcposvelaccb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('calcposvelacc6') == 1) {
  document.getElementById('calcposvelaccb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('calcposvelacc6') == 0) {
  document.getElementById('calcposvelaccb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('calcposvelacc7') == 1) {
  document.getElementById('calcposvelaccb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('calcposvelacc7') == 0) {
  document.getElementById('calcposvelaccb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('calcposvelacc8') == 1) {
  document.getElementById('calcposvelaccb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('calcposvelacc8') == 0) {
  document.getElementById('calcposvelaccb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('calcposvelacc9') == 1) {
  document.getElementById('calcposvelaccb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('calcposvelacc9') == 0) {
  document.getElementById('calcposvelaccb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('calcposvelacc10') == 1) {
  document.getElementById('calcposvelaccb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('calcposvelacc10') == 0) {
  document.getElementById('calcposvelaccb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
