...
if (localStorage.getItem('writrawor1') == 1) {
  document.getElementById('writraworb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('writrawor1') == 0) {
  document.getElementById('writraworb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('writrawor2') == 1) {
    document.getElementById('writraworb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('writrawor2') == 0) {
    document.getElementById('writraworb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('writrawor3') == 1) {
  document.getElementById('writraworb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('writrawor3') == 0) {
  document.getElementById('writraworb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('writrawor4') == 1) {
  document.getElementById('writraworb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('writrawor4') == 0) {
  document.getElementById('writraworb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('writrawor5') == 1) {
    document.getElementById('writraworb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('writrawor5') == 0) {
    document.getElementById('writraworb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('writrawor6') == 1) {
  document.getElementById('writraworb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('writrawor6') == 0) {
  document.getElementById('writraworb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('writrawor7') == 1) {
  document.getElementById('writraworb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('writrawor7') == 0) {
  document.getElementById('writraworb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('writrawor8') == 1) {
  document.getElementById('writraworb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('writrawor8') == 0) {
  document.getElementById('writraworb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('writrawor9') == 1) {
  document.getElementById('writraworb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('writrawor9') == 0) {
  document.getElementById('writraworb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('writrawor10') == 1) {
  document.getElementById('writraworb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('writrawor10') == 0) {
  document.getElementById('writraworb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
