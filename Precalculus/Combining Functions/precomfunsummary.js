...
if (localStorage.getItem('precomfun1') == 1) {
  document.getElementById('precomfunb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('precomfun1') == 0) {
  document.getElementById('precomfunb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('precomfun2') == 1) {
    document.getElementById('precomfunb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('precomfun2') == 0) {
    document.getElementById('precomfunb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('precomfun3') == 1) {
  document.getElementById('precomfunb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('precomfun3') == 0) {
  document.getElementById('precomfunb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('precomfun4') == 1) {
  document.getElementById('precomfunb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('precomfun4') == 0) {
  document.getElementById('precomfunb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('precomfun5') == 1) {
    document.getElementById('precomfunb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('precomfun5') == 0) {
    document.getElementById('precomfunb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('precomfun6') == 1) {
  document.getElementById('precomfunb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('precomfun6') == 0) {
  document.getElementById('precomfunb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('precomfun7') == 1) {
  document.getElementById('precomfunb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('precomfun7') == 0) {
  document.getElementById('precomfunb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('precomfun8') == 1) {
  document.getElementById('precomfunb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('precomfun8') == 0) {
  document.getElementById('precomfunb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('precomfun9') == 1) {
  document.getElementById('precomfunb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('precomfun9') == 0) {
  document.getElementById('precomfunb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('precomfun10') == 1) {
  document.getElementById('precomfunb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('precomfun10') == 0) {
  document.getElementById('precomfunb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
