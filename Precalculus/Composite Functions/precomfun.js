    ...
    if (document.getElementById('sa-precomfun-2') != null) {
      precomfun2But.onclick = function() {
        if (document.getElementById('o-precomfun-21').checked) {
          document.getElementById('r-precomfun-21').style.color = 'red'
          document.getElementById('r-precomfun-21').innerHTML = 'Incorrect!'
          document.getElementById('r-precomfun-23').style.color = 'blue'
          document.getElementById('r-precomfun-23').innerHTML = 'Correct!'
          
          document.getElementById('b-precomfun-23').classList.add("correct")
          document.getElementById('b-precomfun-21').classList.add("incorrect")
    ...
    if (document.getElementById('sa-precomfun-3') != null) {
      precomfun3But.onclick = function() {
        if (document.getElementById('o-precomfun-31').checked) {
          document.getElementById('r-precomfun-31').style.color = 'red'
          document.getElementById('r-precomfun-31').innerHTML = 'Incorrect!'
          document.getElementById('r-precomfun-32').style.color = 'blue'
          document.getElementById('r-precomfun-32').innerHTML = 'Correct!'
          
          document.getElementById('b-precomfun-32').classList.add("correct")
          document.getElementById('b-precomfun-31').classList.add("incorrect")
    ...
    if (document.getElementById('sa-precomfun-4') != null) {
      precomfun4But.onclick = function() {
        if (document.getElementById('o-precomfun-41').checked) {
          document.getElementById('r-precomfun-41').style.color = 'red'
          document.getElementById('r-precomfun-41').innerHTML = 'Incorrect!'
          document.getElementById('r-precomfun-44').style.color = 'blue'
          document.getElementById('r-precomfun-44').innerHTML = 'Correct!'
          
          document.getElementById('b-precomfun-44').classList.add("correct")
          document.getElementById('b-precomfun-41').classList.add("incorrect")
    ...
    if (document.getElementById('sa-precomfun-5') != null) {
      precomfun5But.onclick = function() {
        if (document.getElementById('o-precomfun-51').checked) {
          ...
          document.getElementById('r-precomfun-53').style.color = 'blue'
          document.getElementById('r-precomfun-53').innerHTML = 'Correct!'
          
          document.getElementById('b-precomfun-53').classList.add("correct")
          document.getElementById('b-precomfun-51').classList.add("incorrect")
          document.getElementById('b-precomfun-52').classList.add("incorrect")
        ...
        if (document.getElementById('o-precomfun-52').checked) {
          document.getElementById('r-precomfun-52').style.color = 'red'
          document.getElementById('r-precomfun-52').innerHTML = 'Incorrect!'
          document.getElementById('r-precomfun-53').style.color = 'blue'
          document.getElementById('r-precomfun-53').innerHTML = 'Correct!'
      ...
      precomfun6But.onclick = function() {
        if (document.getElementById('o-precomfun-61').checked) {
          document.getElementById('r-precomfun-61').style.color = 'red'
          document.getElementById('r-precomfun-61').innerHTML = 'Incorrect!'
          document.getElementById('r-precomfun-64').style.color = 'blue'
          document.getElementById('r-precomfun-64').innerHTML = 'Correct!'
          
          document.getElementById('b-precomfun-64').classList.add("correct")
          document.getElementById('b-precomfun-61').classList.add("incorrect")
    ...
    if (document.getElementById('sa-precomfun-7') != null) {
      precomfun7But.onclick = function() {
        if (document.getElementById('o-precomfun-71').checked) {
          ...
          document.getElementById('r-precomfun-74').style.color = 'blue'
          document.getElementById('r-precomfun-74').innerHTML = 'Correct!'
          
          document.getElementById('b-precomfun-74').classList.add("correct")
          ...
          document.getElementById('b-precomfun-73').classList.add("incorrect")
        ...
        if (document.getElementById('o-precomfun-73').checked) {
          document.getElementById('r-precomfun-73').style.color = 'red'
          document.getElementById('r-precomfun-73').innerHTML = 'Incorrect!'
          document.getElementById('r-precomfun-74').style.color = 'blue'
          document.getElementById('r-precomfun-74').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-precomfun-9') != null) {
      precomfun9But.onclick = function() {
        if (document.getElementById('o-precomfun-91').checked) {
          ...
          document.getElementById('r-precomfun-94').style.color = 'blue'
          document.getElementById('r-precomfun-94').innerHTML = 'Correct!'
          
          document.getElementById('b-precomfun-94').classList.add("correct")
          ...
          document.getElementById('b-precomfun-93').classList.add("incorrect")
