...
if (document.getElementById('sa-biopropwater-1') != null) {
  biopropwater1But.onclick = function () {
    if (document.getElementById('o-biopropwater-11').checked) {
      ...
      document.getElementById('r-biopropwater-13').style.color = 'blue'
      document.getElementById('r-biopropwater-13').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-13').classList.add("correct")
      document.getElementById('b-biopropwater-11').classList.add("incorrect")
      document.getElementById('b-biopropwater-12').classList.add("incorrect")
      document.getElementById('b-biopropwater-14').classList.add("incorrect")

      document.getElementById('sa-biopropwater-1').disabled = true;
      document.getElementById('o-biopropwater-11').disabled = true;
      document.getElementById('o-biopropwater-12').disabled = true;
      document.getElementById('o-biopropwater-13').disabled = true;
      document.getElementById('o-biopropwater-14').disabled = true;
      showExplanation1()
...
if (document.getElementById('sa-biopropwater-2') != null) {
  biopropwater2But.onclick = function () {
    if (document.getElementById('o-biopropwater-21').checked) {
      ...
      document.getElementById('r-biopropwater-22').style.color = 'blue'
      document.getElementById('r-biopropwater-22').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-22').classList.add("correct")
      document.getElementById('b-biopropwater-21').classList.add("incorrect")
      document.getElementById('b-biopropwater-23').classList.add("incorrect")
      document.getElementById('b-biopropwater-24').classList.add("incorrect")

      document.getElementById('sa-biopropwater-2').disabled = true;
      document.getElementById('o-biopropwater-21').disabled = true;
      document.getElementById('o-biopropwater-22').disabled = true;
      document.getElementById('o-biopropwater-23').disabled = true;
      document.getElementById('o-biopropwater-24').disabled = true;
      showExplanation2()
...
if (document.getElementById('sa-biopropwater-3') != null) {
  biopropwater3But.onclick = function () {
    if (document.getElementById('o-biopropwater-31').checked) {
      ...
      document.getElementById('r-biopropwater-33').style.color = 'blue'
      document.getElementById('r-biopropwater-33').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-33').classList.add("correct")
      document.getElementById('b-biopropwater-31').classList.add("incorrect")
      document.getElementById('b-biopropwater-32').classList.add("incorrect")
      document.getElementById('b-biopropwater-34').classList.add("incorrect")

      document.getElementById('sa-biopropwater-3').disabled = true;
      document.getElementById('o-biopropwater-31').disabled = true;
      document.getElementById('o-biopropwater-32').disabled = true;
      document.getElementById('o-biopropwater-33').disabled = true;
      document.getElementById('o-biopropwater-34').disabled = true;
      showExplanation3()
...
if (document.getElementById('sa-biopropwater-4') != null) {
  biopropwater4But.onclick = function () {
    if (document.getElementById('o-biopropwater-41').checked) {
      ...
      document.getElementById('r-biopropwater-44').style.color = 'blue'
      document.getElementById('r-biopropwater-44').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-44').classList.add("correct")
      document.getElementById('b-biopropwater-41').classList.add("incorrect")
      document.getElementById('b-biopropwater-42').classList.add("incorrect")
      document.getElementById('b-biopropwater-43').classList.add("incorrect")

      document.getElementById('sa-biopropwater-4').disabled = true;
      document.getElementById('o-biopropwater-41').disabled = true;
      document.getElementById('o-biopropwater-42').disabled = true;
      document.getElementById('o-biopropwater-43').disabled = true;
      document.getElementById('o-biopropwater-44').disabled = true;
      showExplanation4()
...
if (document.getElementById('sa-biopropwater-5') != null) {
  biopropwater5But.onclick = function () {
    if (document.getElementById('o-biopropwater-51').checked) {
      ...
      document.getElementById('r-biopropwater-54').style.color = 'blue'
      document.getElementById('r-biopropwater-54').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-54').classList.add("correct")
      document.getElementById('b-biopropwater-51').classList.add("incorrect")
      document.getElementById('b-biopropwater-52').classList.add("incorrect")
      document.getElementById('b-biopropwater-53').classList.add("incorrect")

      document.getElementById('sa-biopropwater-5').disabled = true;
      document.getElementById('o-biopropwater-51').disabled = true;
      document.getElementById('o-biopropwater-52').disabled = true;
      document.getElementById('o-biopropwater-53').disabled = true;
      document.getElementById('o-biopropwater-54').disabled = true;
      showExplanation5()
...
if (document.getElementById('sa-biopropwater-6') != null) {
  biopropwater6But.onclick = function () {
    if (document.getElementById('o-biopropwater-61').checked) {
      ...
      document.getElementById('r-biopropwater-62').style.color = 'blue'
      document.getElementById('r-biopropwater-62').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-62').classList.add("correct")
      document.getElementById('b-biopropwater-61').classList.add("incorrect")
      document.getElementById('b-biopropwater-63').classList.add("incorrect")
      document.getElementById('b-biopropwater-64').classList.add("incorrect")

      document.getElementById('sa-biopropwater-6').disabled = true;
      document.getElementById('o-biopropwater-61').disabled = true;
      document.getElementById('o-biopropwater-62').disabled = true;
      document.getElementById('o-biopropwater-63').disabled = true;
      document.getElementById('o-biopropwater-64').disabled = true;
      showExplanation6()
...
if (document.getElementById('sa-biopropwater-7') != null) {
  biopropwater7But.onclick = function () {
    if (document.getElementById('o-biopropwater-71').checked) {
      ...
      document.getElementById('r-biopropwater-74').style.color = 'blue'
      document.getElementById('r-biopropwater-74').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-74').classList.add("correct")
      document.getElementById('b-biopropwater-71').classList.add("incorrect")
      document.getElementById('b-biopropwater-72').classList.add("incorrect")
      document.getElementById('b-biopropwater-73').classList.add("incorrect")

      document.getElementById('sa-biopropwater-7').disabled = true;
      document.getElementById('o-biopropwater-71').disabled = true;
      document.getElementById('o-biopropwater-72').disabled = true;
      document.getElementById('o-biopropwater-73').disabled = true;
      document.getElementById('o-biopropwater-74').disabled = true;
      showExplanation7()
...
if (document.getElementById('sa-biopropwater-8') != null) {
  biopropwater8But.onclick = function () {
    if (document.getElementById('o-biopropwater-81').checked) {
      ...
      document.getElementById('r-biopropwater-82').style.color = 'blue'
      document.getElementById('r-biopropwater-82').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-82').classList.add("correct")
      document.getElementById('b-biopropwater-81').classList.add("incorrect")
      document.getElementById('b-biopropwater-83').classList.add("incorrect")
      document.getElementById('b-biopropwater-84').classList.add("incorrect")

      document.getElementById('sa-biopropwater-8').disabled = true;
      document.getElementById('o-biopropwater-81').disabled = true;
      document.getElementById('o-biopropwater-82').disabled = true;
      document.getElementById('o-biopropwater-83').disabled = true;
      document.getElementById('o-biopropwater-84').disabled = true;
      showExplanation8()
...
if (document.getElementById('sa-biopropwater-9') != null) {
  biopropwater9But.onclick = function () {
    if (document.getElementById('o-biopropwater-91').checked) {
      ...
      document.getElementById('r-biopropwater-94').style.color = 'blue'
      document.getElementById('r-biopropwater-94').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-94').classList.add("correct")
      document.getElementById('b-biopropwater-91').classList.add("incorrect")
      document.getElementById('b-biopropwater-92').classList.add("incorrect")
      document.getElementById('b-biopropwater-93').classList.add("incorrect")

      document.getElementById('sa-biopropwater-9').disabled = true;
      document.getElementById('o-biopropwater-91').disabled = true;
      document.getElementById('o-biopropwater-92').disabled = true;
      document.getElementById('o-biopropwater-93').disabled = true;
      document.getElementById('o-biopropwater-94').disabled = true;
      showExplanation9()
...
if (document.getElementById('sa-biopropwater-10') != null) {
  biopropwater10But.onclick = function () {
    if (document.getElementById('o-biopropwater-101').checked) {
      ...
      document.getElementById('r-biopropwater-102').style.color = 'blue'
      document.getElementById('r-biopropwater-102').innerHTML = 'Correct!'

      document.getElementById('b-biopropwater-102').classList.add("correct")
      document.getElementById('b-biopropwater-101').classList.add("incorrect")
      document.getElementById('b-biopropwater-103').classList.add("incorrect")
      document.getElementById('b-biopropwater-104').classList.add("incorrect")

      document.getElementById('sa-biopropwater-10').disabled = true;
      document.getElementById('o-biopropwater-101').disabled = true;
      document.getElementById('o-biopropwater-102').disabled = true;
      document.getElementById('o-biopropwater-103').disabled = true;
      document.getElementById('o-biopropwater-104').disabled = true;
      showExplanation10()
