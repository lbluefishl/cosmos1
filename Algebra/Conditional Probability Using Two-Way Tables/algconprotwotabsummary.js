...
if (localStorage.getItem('algconprotwotab1') == 1) {
  document.getElementById('algconprotwotabb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algconprotwotab1') == 0) {
  document.getElementById('algconprotwotabb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algconprotwotab2') == 1) {
    document.getElementById('algconprotwotabb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algconprotwotab2') == 0) {
    document.getElementById('algconprotwotabb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algconprotwotab3') == 1) {
  document.getElementById('algconprotwotabb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algconprotwotab3') == 0) {
  document.getElementById('algconprotwotabb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algconprotwotab4') == 1) {
  document.getElementById('algconprotwotabb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algconprotwotab4') == 0) {
  document.getElementById('algconprotwotabb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('algconprotwotab5') == 1) {
    document.getElementById('algconprotwotabb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algconprotwotab5') == 0) {
    document.getElementById('algconprotwotabb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algconprotwotab6') == 1) {
  document.getElementById('algconprotwotabb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algconprotwotab6') == 0) {
  document.getElementById('algconprotwotabb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algconprotwotab7') == 1) {
  document.getElementById('algconprotwotabb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algconprotwotab7') == 0) {
  document.getElementById('algconprotwotabb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algconprotwotab8') == 1) {
  document.getElementById('algconprotwotabb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algconprotwotab8') == 0) {
  document.getElementById('algconprotwotabb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algconprotwotab9') == 1) {
  document.getElementById('algconprotwotabb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algconprotwotab9') == 0) {
  document.getElementById('algconprotwotabb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algconprotwotab10') == 1) {
  document.getElementById('algconprotwotabb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algconprotwotab10') == 0) {
  document.getElementById('algconprotwotabb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
