    ...
    if (document.getElementById('sa-algconprotwotab-5') != null) {
      algconprotwotab5But.onclick = function() {
        if (document.getElementById('o-algconprotwotab-51').checked) {
          document.getElementById('r-algconprotwotab-51').style.color = 'red'
          document.getElementById('r-algconprotwotab-51').innerHTML = 'Incorrect!'
          document.getElementById('r-algconprotwotab-53').style.color = 'blue'
          document.getElementById('r-algconprotwotab-53').innerHTML = 'Correct!'
          
          document.getElementById('b-algconprotwotab-53').classList.add("correct")
          document.getElementById('b-algconprotwotab-51').classList.add("incorrect")
      ...
      algconprotwotab6But.onclick = function() {
        if (document.getElementById('o-algconprotwotab-61').checked) {
          ...
          document.getElementById('r-algconprotwotab-64').style.color = 'blue'
          document.getElementById('r-algconprotwotab-64').innerHTML = 'Correct!'
          
          document.getElementById('b-algconprotwotab-64').classList.add("correct")
          ...
          document.getElementById('b-algconprotwotab-63').classList.add("incorrect")
        ...
        if (document.getElementById('o-algconprotwotab-63').checked) {
          document.getElementById('r-algconprotwotab-63').style.color = 'red'
          document.getElementById('r-algconprotwotab-63').innerHTML = 'Incorrect!'
          document.getElementById('r-algconprotwotab-64').style.color = 'blue'
          document.getElementById('r-algconprotwotab-64').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algconprotwotab-7') != null) {
      algconprotwotab7But.onclick = function() {
        if (document.getElementById('o-algconprotwotab-71').checked) {
          ...
          document.getElementById('r-algconprotwotab-74').style.color = 'blue'
          document.getElementById('r-algconprotwotab-74').innerHTML = 'Correct!'
          
          document.getElementById('b-algconprotwotab-74').classList.add("correct")
          ...
          document.getElementById('b-algconprotwotab-73').classList.add("incorrect")
        ...
        if (document.getElementById('o-algconprotwotab-73').checked) {
          document.getElementById('r-algconprotwotab-73').style.color = 'red'
          document.getElementById('r-algconprotwotab-73').innerHTML = 'Incorrect!'
          document.getElementById('r-algconprotwotab-74').style.color = 'blue'
          document.getElementById('r-algconprotwotab-74').innerHTML = 'Correct!'
