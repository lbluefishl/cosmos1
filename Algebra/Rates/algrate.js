     ...
     if (document.getElementById('sa-algrate-1') != null) {
      algrate1But.onclick = function () {
        if (document.getElementById('o-algrate-11').checked) {
          document.getElementById('r-algrate-11').style.color = 'blue'
          document.getElementById('r-algrate-11').innerHTML = 'Correct!'
    
          document.getElementById('b-algrate-11').classList.add("correct")
          document.getElementById('b-algrate-12').classList.add("incorrect")
          document.getElementById('b-algrate-13').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrate-13').checked) {
          document.getElementById('r-algrate-13').style.color = 'red'
          document.getElementById('r-algrate-13').innerHTML = 'Incorrect!'
          document.getElementById('r-algrate-11').style.color = 'blue'
          document.getElementById('r-algrate-11').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algrate-2') != null) {
      algrate2But.onclick = function() {
        if (document.getElementById('o-algrate-21').checked) {
          document.getElementById('r-algrate-21').style.color = 'red'
          document.getElementById('r-algrate-21').innerHTML = 'Incorrect!'
          document.getElementById('r-algrate-23').style.color = 'blue'
          document.getElementById('r-algrate-23').innerHTML = 'Correct!'
          
          document.getElementById('b-algrate-23').classList.add("correct")
          document.getElementById('b-algrate-21').classList.add("incorrect")
    ...
    if (document.getElementById('sa-algrate-4') != null) {
      algrate4But.onclick = function() {
        if (document.getElementById('o-algrate-41').checked) {
          ...
          document.getElementById('r-algrate-44').style.color = 'blue'
          document.getElementById('r-algrate-44').innerHTML = 'Correct!'
          
          document.getElementById('b-algrate-44').classList.add("correct")
          document.getElementById('b-algrate-41').classList.add("incorrect")
          document.getElementById('b-algrate-42').classList.add("incorrect")
          document.getElementById('b-algrate-43').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrate-43').checked) {
          document.getElementById('r-algrate-43').style.color = 'red'
          document.getElementById('r-algrate-43').innerHTML = 'Incorrect!'
          document.getElementById('r-algrate-44').style.color = 'blue'
          document.getElementById('r-algrate-44').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algrate-5') != null) {
      ...
      algrate6But.onclick = function() {
        if (document.getElementById('o-algrate-61').checked) {
          ...
          document.getElementById('r-algrate-64').style.color = 'blue'
          document.getElementById('r-algrate-64').innerHTML = 'Correct!'
          
          document.getElementById('b-algrate-64').classList.add("correct")
          document.getElementById('b-algrate-61').classList.add("incorrect")
          document.getElementById('b-algrate-62').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrate-62').checked) {
          document.getElementById('r-algrate-62').style.color = 'red'
          document.getElementById('r-algrate-62').innerHTML = 'Incorrect!'
          document.getElementById('r-algrate-64').style.color = 'blue'
          document.getElementById('r-algrate-64').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algrate-7') != null) {
      algrate7But.onclick = function() {
        if (document.getElementById('o-algrate-71').checked) {
          ...
          document.getElementById('r-algrate-74').style.color = 'blue'
          document.getElementById('r-algrate-74').innerHTML = 'Correct!'
          
          document.getElementById('b-algrate-74').classList.add("correct")
          document.getElementById('b-algrate-71').classList.add("incorrect")
          document.getElementById('b-algrate-72').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrate-72').checked) {
          document.getElementById('r-algrate-72').style.color = 'red'
          document.getElementById('r-algrate-72').innerHTML = 'Incorrect!'
          document.getElementById('r-algrate-74').style.color = 'blue'
          document.getElementById('r-algrate-74').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algrate-8') != null) {
      algrate8But.onclick = function() {
        if (document.getElementById('o-algrate-81').checked) {
          ...
          document.getElementById('r-algrate-82').style.color = 'blue'
          document.getElementById('r-algrate-82').innerHTML = 'Correct!'
          
          document.getElementById('b-algrate-82').classList.add("correct")
          document.getElementById('b-algrate-81').classList.add("incorrect")
          document.getElementById('b-algrate-83').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrate-83').checked) {
          document.getElementById('r-algrate-83').style.color = 'red'
          document.getElementById('r-algrate-83').innerHTML = 'Incorrect!'
          document.getElementById('r-algrate-82').style.color = 'blue'
          document.getElementById('r-algrate-82').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algrate-9') != null) {
      algrate9But.onclick = function() {
        if (document.getElementById('o-algrate-91').checked) {
          ...
          document.getElementById('r-algrate-94').style.color = 'blue'
          document.getElementById('r-algrate-94').innerHTML = 'Correct!'
          
          document.getElementById('b-algrate-94').classList.add("correct")
          document.getElementById('b-algrate-91').classList.add("incorrect")
          document.getElementById('b-algrate-92').classList.add("incorrect")
    ...
    if (document.getElementById('sa-algrate-10') != null) {
      algrate10But.onclick = function() {
        if (document.getElementById('o-algrate-101').checked) {
          ...
          document.getElementById('r-algrate-102').style.color = 'blue'
          document.getElementById('r-algrate-102').innerHTML = 'Correct!'
          
          document.getElementById('b-algrate-102').classList.add("correct")
          document.getElementById('b-algrate-101').classList.add("incorrect")
          document.getElementById('b-algrate-103').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrate-103').checked) {
          document.getElementById('r-algrate-103').style.color = 'red'
          document.getElementById('r-algrate-103').innerHTML = 'Incorrect!'
          document.getElementById('r-algrate-102').style.color = 'blue'
          document.getElementById('r-algrate-102').innerHTML = 'Correct!'
