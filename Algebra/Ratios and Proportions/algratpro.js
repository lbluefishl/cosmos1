    ...
    if (document.getElementById('sa-algratpro-2') != null) {
      algratpro2But.onclick = function() {
        if (document.getElementById('o-algratpro-21').checked) {
          ...
          document.getElementById('r-algratpro-23').style.color = 'blue'
          document.getElementById('r-algratpro-23').innerHTML = 'Correct!'
          
          document.getElementById('b-algratpro-23').classList.add("correct")
          document.getElementById('b-algratpro-21').classList.add("incorrect")
          document.getElementById('b-algratpro-22').classList.add("incorrect")
        ...
        if (document.getElementById('o-algratpro-22').checked) {
          document.getElementById('r-algratpro-22').style.color = 'red'
          document.getElementById('r-algratpro-22').innerHTML = 'Incorrect!'
          document.getElementById('r-algratpro-23').style.color = 'blue'
          document.getElementById('r-algratpro-23').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algratpro-5') != null) {
      ...
      algratpro6But.onclick = function() {
        if (document.getElementById('o-algratpro-61').checked) {
          ...
          document.getElementById('r-algratpro-64').style.color = 'blue'
          document.getElementById('r-algratpro-64').innerHTML = 'Correct!'
          
          document.getElementById('b-algratpro-64').classList.add("correct")
          ...
          document.getElementById('b-algratpro-63').classList.add("incorrect")
        ...
        if (document.getElementById('o-algratpro-63').checked) {
          document.getElementById('r-algratpro-63').style.color = 'red'
          document.getElementById('r-algratpro-63').innerHTML = 'Incorrect!'
          document.getElementById('r-algratpro-64').style.color = 'blue'
          document.getElementById('r-algratpro-64').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algratpro-7') != null) {
      algratpro7But.onclick = function() {
        if (document.getElementById('o-algratpro-71').checked) {
          ...
          document.getElementById('r-algratpro-74').style.color = 'blue'
          document.getElementById('r-algratpro-74').innerHTML = 'Correct!'
          
          document.getElementById('b-algratpro-74').classList.add("correct")
          ...
          document.getElementById('b-algratpro-73').classList.add("incorrect")
        ...
        if (document.getElementById('o-algratpro-73').checked) {
          document.getElementById('r-algratpro-73').style.color = 'red'
          document.getElementById('r-algratpro-73').innerHTML = 'Incorrect!'
          document.getElementById('r-algratpro-74').style.color = 'blue'
          document.getElementById('r-algratpro-74').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algratpro-8') != null) {
      algratpro8But.onclick = function() {
        if (document.getElementById('o-algratpro-81').checked) {
          document.getElementById('r-algratpro-81').style.color = 'red'
          document.getElementById('r-algratpro-81').innerHTML = 'Incorrect!'
          document.getElementById('r-algratpro-82').style.color = 'blue'
          document.getElementById('r-algratpro-82').innerHTML = 'Correct!'
          
          document.getElementById('b-algratpro-82').classList.add("correct")
          document.getElementById('b-algratpro-81').classList.add("incorrect")
