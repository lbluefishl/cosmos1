...
if (localStorage.getItem('algratpro1') == 1) {
  document.getElementById('algratprob1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algratpro1') == 0) {
  document.getElementById('algratprob1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algratpro2') == 1) {
    document.getElementById('algratprob2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algratpro2') == 0) {
    document.getElementById('algratprob2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algratpro3') == 1) {
  document.getElementById('algratprob3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algratpro3') == 0) {
  document.getElementById('algratprob3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algratpro4') == 1) {
  document.getElementById('algratprob4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algratpro4') == 0) {
  document.getElementById('algratprob4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('algratpro5') == 1) {
    document.getElementById('algratprob5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algratpro5') == 0) {
    document.getElementById('algratprob5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algratpro6') == 1) {
  document.getElementById('algratprob6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algratpro6') == 0) {
  document.getElementById('algratprob6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algratpro7') == 1) {
  document.getElementById('algratprob7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algratpro7') == 0) {
  document.getElementById('algratprob7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algratpro8') == 1) {
  document.getElementById('algratprob8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algratpro8') == 0) {
  document.getElementById('algratprob8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algratpro9') == 1) {
  document.getElementById('algratprob9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algratpro9') == 0) {
  document.getElementById('algratprob9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algratpro10') == 1) {
  document.getElementById('algratprob10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algratpro10') == 0) {
  document.getElementById('algratprob10').style.background = 'rgb(255, 213, 128)';
  }
  else {
