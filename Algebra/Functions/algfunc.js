    ...
    if (document.getElementById('sa-algfunc-2') != null) {
      algfunc2But.onclick = function() {
        if (document.getElementById('o-algfunc-21').checked) {
          ...
          document.getElementById('r-algfunc-23').style.color = 'blue'
          document.getElementById('r-algfunc-23').innerHTML = 'Correct!'
          
          document.getElementById('b-algfunc-23').classList.add("correct")
          document.getElementById('b-algfunc-21').classList.add("incorrect")
          document.getElementById('b-algfunc-22').classList.add("incorrect")
        ...
        if (document.getElementById('o-algfunc-22').checked) {
          document.getElementById('r-algfunc-22').style.color = 'red'
          document.getElementById('r-algfunc-22').innerHTML = 'Incorrect!'
          document.getElementById('r-algfunc-23').style.color = 'blue'
          document.getElementById('r-algfunc-23').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algfunc-3') != null) {
      algfunc3But.onclick = function() {
        if (document.getElementById('o-algfunc-31').checked) {
          ...
          document.getElementById('r-algfunc-32').style.color = 'blue'
          document.getElementById('r-algfunc-32').innerHTML = 'Correct!'
          
          document.getElementById('b-algfunc-32').classList.add("correct")
          document.getElementById('b-algfunc-31').classList.add("incorrect")
          document.getElementById('b-algfunc-33').classList.add("incorrect")
        ...
        if (document.getElementById('o-algfunc-33').checked) {
          document.getElementById('r-algfunc-33').style.color = 'red'
          document.getElementById('r-algfunc-33').innerHTML = 'Incorrect!'
          document.getElementById('r-algfunc-32').style.color = 'blue'
          document.getElementById('r-algfunc-32').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algfunc-4') != null) {
      algfunc4But.onclick = function() {
        if (document.getElementById('o-algfunc-41').checked) {
          document.getElementById('r-algfunc-41').style.color = 'red'
          document.getElementById('r-algfunc-41').innerHTML = 'Incorrect!'
          document.getElementById('r-algfunc-44').style.color = 'blue'
          document.getElementById('r-algfunc-44').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algfunc-5') != null) {
      algfunc5But.onclick = function() {
        if (document.getElementById('o-algfunc-51').checked) {
          ...
          document.getElementById('r-algfunc-53').style.color = 'blue'
          document.getElementById('r-algfunc-53').innerHTML = 'Correct!'
          
          document.getElementById('b-algfunc-53').classList.add("correct")
          document.getElementById('b-algfunc-51').classList.add("incorrect")
          document.getElementById('b-algfunc-52').classList.add("incorrect")
        ...
        if (document.getElementById('o-algfunc-52').checked) {
          document.getElementById('r-algfunc-52').style.color = 'red'
          document.getElementById('r-algfunc-52').innerHTML = 'Incorrect!'
          document.getElementById('r-algfunc-53').style.color = 'blue'
          document.getElementById('r-algfunc-53').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algfunc-8') != null) {
      algfunc8But.onclick = function() {
        if (document.getElementById('o-algfunc-81').checked) {
          ...
          document.getElementById('r-algfunc-82').style.color = 'blue'
          document.getElementById('r-algfunc-82').innerHTML = 'Correct!'
          
          document.getElementById('b-algfunc-82').classList.add("correct")
          document.getElementById('b-algfunc-81').classList.add("incorrect")
          document.getElementById('b-algfunc-83').classList.add("incorrect")
        ...
        if (document.getElementById('o-algfunc-83').checked) {
          document.getElementById('r-algfunc-83').style.color = 'red'
          document.getElementById('r-algfunc-83').innerHTML = 'Incorrect!'
          document.getElementById('r-algfunc-82').style.color = 'blue'
          document.getElementById('r-algfunc-82').innerHTML = 'Correct!'
