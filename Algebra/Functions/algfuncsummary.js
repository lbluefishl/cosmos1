...
if (localStorage.getItem('algfunc1') == 1) {
  document.getElementById('algfuncb1').style.background = '#7fff00';
}
  else if (localStorage.getItem('algfunc1') == 0) {
  document.getElementById('algfuncb1').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algfunc2') == 1) {
    document.getElementById('algfuncb2').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algfunc2') == 0) {
    document.getElementById('algfuncb2').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algfunc3') == 1) {
  document.getElementById('algfuncb3').style.background = '#7fff00';
}
  else if (localStorage.getItem('algfunc3') == 0) {
  document.getElementById('algfuncb3').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algfunc4') == 1) {
  document.getElementById('algfuncb4').style.background = '#7fff00';
}
  else if (localStorage.getItem('algfunc4') == 0) {
  document.getElementById('algfuncb4').style.background = 'red';
  }
  else {
  ...
  if (localStorage.getItem('algfunc5') == 1) {
    document.getElementById('algfuncb5').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algfunc5') == 0) {
    document.getElementById('algfuncb5').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algfunc6') == 1) {
  document.getElementById('algfuncb6').style.background = '#7fff00';
}
  else if (localStorage.getItem('algfunc6') == 0) {
  document.getElementById('algfuncb6').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algfunc7') == 1) {
  document.getElementById('algfuncb7').style.background = '#7fff00';
}
  else if (localStorage.getItem('algfunc7') == 0) {
  document.getElementById('algfuncb7').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algfunc8') == 1) {
  document.getElementById('algfuncb8').style.background = '#7fff00';
}
  else if (localStorage.getItem('algfunc8') == 0) {
  document.getElementById('algfuncb8').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algfunc9') == 1) {
  document.getElementById('algfuncb9').style.background = '#7fff00';
}
  else if (localStorage.getItem('algfunc9') == 0) {
  document.getElementById('algfuncb9').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algfunc10') == 1) {
  document.getElementById('algfuncalgfuncb10').style.background = '#7fff00';
}
  else if (localStorage.getItem('algfunc10') == 0) {
  document.getElementById('algfuncb10').style.background = 'red';
  }
  else {
