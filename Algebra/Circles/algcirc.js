    ...
    if (document.getElementById('sa-algcirc-3') != null) {
      algcirc3But.onclick = function() {
        if (document.getElementById('o-algcirc-31').checked) {
          ...
          document.getElementById('r-algcirc-33').style.color = 'blue'
          document.getElementById('r-algcirc-33').innerHTML = 'Correct!'
          
          document.getElementById('b-algcirc-33').classList.add("correct")
          document.getElementById('b-algcirc-31').classList.add("incorrect")
          document.getElementById('b-algcirc-32').classList.add("incorrect")
        ...
        if (document.getElementById('o-algcirc-32').checked) {
          document.getElementById('r-algcirc-32').style.color = 'red'
          document.getElementById('r-algcirc-32').innerHTML = 'Incorrect!'
          document.getElementById('r-algcirc-33').style.color = 'blue'
          document.getElementById('r-algcirc-33').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algcirc-4') != null) {
      algcirc4But.onclick = function() {
        if (document.getElementById('o-algcirc-41').checked) {
          ...
          document.getElementById('r-algcirc-43').style.color = 'blue'
          document.getElementById('r-algcirc-43').innerHTML = 'Correct!'
          
          document.getElementById('b-algcirc-43').classList.add("correct")
          document.getElementById('b-algcirc-41').classList.add("incorrect")
          document.getElementById('b-algcirc-42').classList.add("incorrect")
          document.getElementById('b-algcirc-44').classList.add("incorrect")
        ...
        if (document.getElementById('o-algcirc-44').checked) {
          document.getElementById('r-algcirc-44').style.color = 'red'
          document.getElementById('r-algcirc-44').innerHTML = 'Incorrect!'
          document.getElementById('r-algcirc-43').style.color = 'blue'
          document.getElementById('r-algcirc-43').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algcirc-5') != null) {
      ...
      algcirc6But.onclick = function() {
        if (document.getElementById('o-algcirc-61').checked) {
          ...
          document.getElementById('r-algcirc-63').style.color = 'blue'
          document.getElementById('r-algcirc-63').innerHTML = 'Correct!'
          
          document.getElementById('b-algcirc-63').classList.add("correct")
          document.getElementById('b-algcirc-61').classList.add("incorrect")
          document.getElementById('b-algcirc-62').classList.add("incorrect")
          document.getElementById('b-algcirc-64').classList.add("incorrect")
        ...
        if (document.getElementById('o-algcirc-64').checked) {
          document.getElementById('r-algcirc-64').style.color = 'red'
          document.getElementById('r-algcirc-64').innerHTML = 'Incorrect!'
          document.getElementById('r-algcirc-63').style.color = 'blue'
          document.getElementById('r-algcirc-63').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algcirc-7') != null) {
      algcirc7But.onclick = function() {
        if (document.getElementById('o-algcirc-71').checked) {
          ...
          document.getElementById('r-algcirc-73').style.color = 'blue'
          document.getElementById('r-algcirc-73').innerHTML = 'Correct!'
          
          document.getElementById('b-algcirc-73').classList.add("correct")
          document.getElementById('b-algcirc-71').classList.add("incorrect")
          document.getElementById('b-algcirc-72').classList.add("incorrect")
          document.getElementById('b-algcirc-74').classList.add("incorrect")
        ...
        if (document.getElementById('o-algcirc-74').checked) {
          document.getElementById('r-algcirc-74').style.color = 'red'
          document.getElementById('r-algcirc-74').innerHTML = 'Incorrect!'
          document.getElementById('r-algcirc-73').style.color = 'blue'
          document.getElementById('r-algcirc-73').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algcirc-8') != null) {
      algcirc8But.onclick = function() {
        if (document.getElementById('o-algcirc-81').checked) {
          ...
          document.getElementById('r-algcirc-83').style.color = 'blue'
          document.getElementById('r-algcirc-83').innerHTML = 'Correct!'
          
          document.getElementById('b-algcirc-83').classList.add("correct")
          document.getElementById('b-algcirc-81').classList.add("incorrect")
          document.getElementById('b-algcirc-82').classList.add("incorrect")
        ...
        if (document.getElementById('o-algcirc-82').checked) {
          document.getElementById('r-algcirc-82').style.color = 'red'
          document.getElementById('r-algcirc-82').innerHTML = 'Incorrect!'
          document.getElementById('r-algcirc-83').style.color = 'blue'
          document.getElementById('r-algcirc-83').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algcirc-9') != null) {
      algcirc9But.onclick = function() {
        if (document.getElementById('o-algcirc-91').checked) {
          ...
          document.getElementById('r-algcirc-92').style.color = 'blue'
          document.getElementById('r-algcirc-92').innerHTML = 'Correct!'
          
          document.getElementById('b-algcirc-92').classList.add("correct")
          document.getElementById('b-algcirc-91').classList.add("incorrect")
          document.getElementById('b-algcirc-93').classList.add("incorrect")
          document.getElementById('b-algcirc-94').classList.add("incorrect")
        ...
        if (document.getElementById('o-algcirc-93').checked) {
          document.getElementById('r-algcirc-93').style.color = 'red'
          document.getElementById('r-algcirc-93').innerHTML = 'Incorrect!'
          document.getElementById('r-algcirc-92').style.color = 'blue'
          document.getElementById('r-algcirc-92').innerHTML = 'Correct!'
        ...
        if (document.getElementById('o-algcirc-94').checked) {
          document.getElementById('r-algcirc-94').style.color = 'red'
          document.getElementById('r-algcirc-94').innerHTML = 'Incorrect!'
          document.getElementById('r-algcirc-92').style.color = 'blue'
          document.getElementById('r-algcirc-92').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algcirc-10') != null) {
      algcirc10But.onclick = function() {
        if (document.getElementById('o-algcirc-101').checked) {
          ...
          document.getElementById('r-algcirc-104').style.color = 'blue'
          document.getElementById('r-algcirc-104').innerHTML = 'Correct!'
          
          document.getElementById('b-algcirc-104').classList.add("correct")
          ...
          document.getElementById('b-algcirc-102').classList.add("incorrect")
        ...
        if (document.getElementById('o-algcirc-102').checked) {
          document.getElementById('r-algcirc-102').style.color = 'red'
          document.getElementById('r-algcirc-102').innerHTML = 'Incorrect!'
          document.getElementById('r-algcirc-104').style.color = 'blue'
          document.getElementById('r-algcirc-104').innerHTML = 'Correct!'
