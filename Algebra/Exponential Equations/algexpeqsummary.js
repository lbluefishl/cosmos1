...
if (localStorage.getItem('algexpeq1') == 1) {
  document.getElementById('algexpeqb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpeq1') == 0) {
  document.getElementById('algexpeqb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpeq2') == 1) {
    document.getElementById('algexpeqb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algexpeq2') == 0) {
    document.getElementById('algexpeqb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algexpeq3') == 1) {
  document.getElementById('algexpeqb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpeq3') == 0) {
  document.getElementById('algexpeqb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpeq4') == 1) {
  document.getElementById('algexpeqb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpeq4') == 0) {
  document.getElementById('algexpeqb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('algexpeq5') == 1) {
    document.getElementById('algexpeqb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algexpeq5') == 0) {
    document.getElementById('algexpeqb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algexpeq6') == 1) {
  document.getElementById('algexpeqb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpeq6') == 0) {
  document.getElementById('algexpeqb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpeq7') == 1) {
  document.getElementById('algexpeqb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpeq7') == 0) {
  document.getElementById('algexpeqb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpeq8') == 1) {
  document.getElementById('algexpeqb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpeq8') == 0) {
  document.getElementById('algexpeqb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpeq9') == 1) {
  document.getElementById('algexpeqb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpeq9') == 0) {
  document.getElementById('algexpeqb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpeq10') == 1) {
  document.getElementById('algexpeqb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpeq10') == 0) {
  document.getElementById('algexpeqb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
