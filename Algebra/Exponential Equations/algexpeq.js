    ...
    if (document.getElementById('sa-algexpeq-5') != null) {
      ...
      algexpeq6But.onclick = function() {
        if (document.getElementById('o-algexpeq-61').checked) {
          ...
          document.getElementById('r-algexpeq-62').style.color = 'blue'
          document.getElementById('r-algexpeq-62').innerHTML = 'Correct!'
          
          document.getElementById('b-algexpeq-62').classList.add("correct")
          document.getElementById('b-algexpeq-61').classList.add("incorrect")
          document.getElementById('b-algexpeq-64').classList.add("incorrect")
        ...
        if (document.getElementById('o-algexpeq-64').checked) {
          document.getElementById('r-algexpeq-64').style.color = 'red'
          document.getElementById('r-algexpeq-64').innerHTML = 'Incorrect!'
          document.getElementById('r-algexpeq-62').style.color = 'blue'
          document.getElementById('r-algexpeq-62').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algexpeq-8') != null) {
      algexpeq8But.onclick = function() {
        if (document.getElementById('o-algexpeq-81').checked) {
          ...
          document.getElementById('r-algexpeq-84').style.color = 'blue'
          document.getElementById('r-algexpeq-84').innerHTML = 'Correct!'
          
          document.getElementById('b-algexpeq-84').classList.add("correct")
          ...
          document.getElementById('b-algexpeq-82').classList.add("incorrect")
        ...
        if (document.getElementById('o-algexpeq-82').checked) {
          document.getElementById('r-algexpeq-82').style.color = 'red'
          document.getElementById('r-algexpeq-82').innerHTML = 'Incorrect!'
          document.getElementById('r-algexpeq-84').style.color = 'blue'
          document.getElementById('r-algexpeq-84').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algexpeq-9') != null) {
      algexpeq9But.onclick = function() {
        if (document.getElementById('o-algexpeq-91').checked) {
          ...
          document.getElementById('r-algexpeq-93').style.color = 'blue'
          document.getElementById('r-algexpeq-93').innerHTML = 'Correct!'
          
          document.getElementById('b-algexpeq-93').classList.add("correct")
          ...
          document.getElementById('b-algexpeq-94').classList.add("incorrect")
        ...
        if (document.getElementById('o-algexpeq-92').checked) {
          document.getElementById('r-algexpeq-92').style.color = 'red'
          document.getElementById('r-algexpeq-92').innerHTML = 'Incorrect!'
          document.getElementById('r-algexpeq-93').style.color = 'blue'
          document.getElementById('r-algexpeq-93').innerHTML = 'Correct!'
        ...
        if (document.getElementById('o-algexpeq-94').checked) {
          document.getElementById('r-algexpeq-94').style.color = 'red'
          document.getElementById('r-algexpeq-94').innerHTML = 'Incorrect!'
          document.getElementById('r-algexpeq-93').style.color = 'blue'
          document.getElementById('r-algexpeq-93').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algexpeq-10') != null) {
      algexpeq10But.onclick = function() {
        if (document.getElementById('o-algexpeq-101').checked) {
          ...
          document.getElementById('r-algexpeq-103').style.color = 'blue'
          document.getElementById('r-algexpeq-103').innerHTML = 'Correct!'
          
          document.getElementById('b-algexpeq-103').classList.add("correct")
          document.getElementById('b-algexpeq-101').classList.add("incorrect")
          document.getElementById('b-algexpeq-102').classList.add("incorrect")
        ...
        if (document.getElementById('o-algexpeq-102').checked) {
          document.getElementById('r-algexpeq-102').style.color = 'red'
          document.getElementById('r-algexpeq-102').innerHTML = 'Incorrect!'
          document.getElementById('r-algexpeq-103').style.color = 'blue'
          document.getElementById('r-algexpeq-103').innerHTML = 'Correct!'
