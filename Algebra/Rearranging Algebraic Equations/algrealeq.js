    ...
    if (document.getElementById('sa-algrealeq-5') != null) {
      ...
      algrealeq6But.onclick = function() {
        if (document.getElementById('o-algrealeq-61').checked) {
          ...
          document.getElementById('r-algrealeq-62').style.color = 'blue'
          document.getElementById('r-algrealeq-62').innerHTML = 'Correct!'
          
          document.getElementById('b-algrealeq-62').classList.add("correct")
          document.getElementById('b-algrealeq-61').classList.add("incorrect")
          document.getElementById('b-algrealeq-64').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrealeq-64').checked) {
          document.getElementById('r-algrealeq-64').style.color = 'red'
          document.getElementById('r-algrealeq-64').innerHTML = 'Incorrect!'
          document.getElementById('r-algrealeq-62').style.color = 'blue'
          document.getElementById('r-algrealeq-62').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algrealeq-7') != null) {
      algrealeq7But.onclick = function() {
        if (document.getElementById('o-algrealeq-71').checked) {
          ...
          document.getElementById('r-algrealeq-73').style.color = 'blue'
          document.getElementById('r-algrealeq-73').innerHTML = 'Correct!'
          
          document.getElementById('b-algrealeq-73').classList.add("correct")
          ...
          document.getElementById('b-algrealeq-74').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrealeq-74').checked) {
          document.getElementById('r-algrealeq-74').style.color = 'red'
          document.getElementById('r-algrealeq-74').innerHTML = 'Incorrect!'
          document.getElementById('r-algrealeq-73').style.color = 'blue'
          document.getElementById('r-algrealeq-73').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algrealeq-8') != null) {
      algrealeq8But.onclick = function() {
        if (document.getElementById('o-algrealeq-81').checked) {
          ...
          document.getElementById('r-algrealeq-84').style.color = 'blue'
          document.getElementById('r-algrealeq-84').innerHTML = 'Correct!'
          
          document.getElementById('b-algrealeq-84').classList.add("correct")
          ...
          document.getElementById('b-algrealeq-82').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrealeq-82').checked) {
          document.getElementById('r-algrealeq-82').style.color = 'red'
          document.getElementById('r-algrealeq-82').innerHTML = 'Incorrect!'
          document.getElementById('r-algrealeq-84').style.color = 'blue'
          document.getElementById('r-algrealeq-84').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algrealeq-10') != null) {
      algrealeq10But.onclick = function() {
        if (document.getElementById('o-algrealeq-101').checked) {
          document.getElementById('r-algrealeq-101').style.color = 'blue'
          document.getElementById('r-algrealeq-101').innerHTML = 'Correct!'
          
          document.getElementById('b-algrealeq-101').classList.add("correct")
          document.getElementById('b-algrealeq-102').classList.add("incorrect")
        ...
        if (document.getElementById('o-algrealeq-102').checked) {
          document.getElementById('r-algrealeq-102').style.color = 'red'
          document.getElementById('r-algrealeq-102').innerHTML = 'Incorrect!'
          document.getElementById('r-algrealeq-101').style.color = 'blue'
          document.getElementById('r-algrealeq-101').innerHTML = 'Correct!'
