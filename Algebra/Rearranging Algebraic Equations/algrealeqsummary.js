...
if (localStorage.getItem('algrealeq1') == 1) {
  document.getElementById('algrealeqb1').style.background = '#7fff00';
}
  else if (localStorage.getItem('algrealeq1') == 0) {
  document.getElementById('algrealeqb1').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algrealeq2') == 1) {
    document.getElementById('algrealeqb2').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algrealeq2') == 0) {
    document.getElementById('algrealeqb2').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algrealeq3') == 1) {
  document.getElementById('algrealeqb3').style.background = '#7fff00';
}
  else if (localStorage.getItem('algrealeq3') == 0) {
  document.getElementById('algrealeqb3').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algrealeq4') == 1) {
  document.getElementById('algrealeqb4').style.background = '#7fff00';
}
  else if (localStorage.getItem('algrealeq4') == 0) {
  document.getElementById('algrealeqb4').style.background = 'red';
  }
  else {
  ...
  if (localStorage.getItem('algrealeq5') == 1) {
    document.getElementById('algrealeqb5').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algrealeq5') == 0) {
    document.getElementById('algrealeqb5').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algrealeq6') == 1) {
  document.getElementById('algrealeqb6').style.background = '#7fff00';
}
  else if (localStorage.getItem('algrealeq6') == 0) {
  document.getElementById('algrealeqb6').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algrealeq7') == 1) {
  document.getElementById('algrealeqb7').style.background = '#7fff00';
}
  else if (localStorage.getItem('algrealeq7') == 0) {
  document.getElementById('algrealeqb7').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algrealeq8') == 1) {
  document.getElementById('algrealeqb8').style.background = '#7fff00';
}
  else if (localStorage.getItem('algrealeq8') == 0) {
  document.getElementById('algrealeqb8').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algrealeq9') == 1) {
  document.getElementById('algrealeqb9').style.background = '#7fff00';
}
  else if (localStorage.getItem('algrealeq9') == 0) {
  document.getElementById('algrealeqb9').style.background = 'red';
  }
  else {
