...
if (localStorage.getItem('geolinang1') == 1) {
  document.getElementById('geolinangb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('geolinang1') == 0) {
  document.getElementById('geolinangb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('geolinang2') == 1) {
    document.getElementById('geolinangb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('geolinang2') == 0) {
    document.getElementById('geolinangb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('geolinang3') == 1) {
  document.getElementById('geolinangb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('geolinang3') == 0) {
  document.getElementById('geolinangb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('geolinang4') == 1) {
  document.getElementById('geolinangb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('geolinang4') == 0) {
  document.getElementById('geolinangb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('geolinang5') == 1) {
    document.getElementById('geolinangb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('geolinang5') == 0) {
    document.getElementById('geolinangb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('geolinang6') == 1) {
  document.getElementById('geolinangb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('geolinang6') == 0) {
  document.getElementById('geolinangb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('geolinang7') == 1) {
  document.getElementById('geolinangb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('geolinang7') == 0) {
  document.getElementById('geolinangb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('geolinang8') == 1) {
  document.getElementById('geolinangb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('geolinang8') == 0) {
  document.getElementById('geolinangb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('geolinang9') == 1) {
  document.getElementById('geolinangb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('geolinang9') == 0) {
  document.getElementById('geolinangb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('geolinang10') == 1) {
  document.getElementById('geolinangb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('geolinang10') == 0) {
  document.getElementById('geolinangb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
