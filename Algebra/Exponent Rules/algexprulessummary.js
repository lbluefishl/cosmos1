...
if (localStorage.getItem('algexprules1') == 1) {
  document.getElementById('algexprulesb1').style.background = '#7fff00';
}
  else if (localStorage.getItem('algexprules1') == 0) {
  document.getElementById('algexprulesb1').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algexprules2') == 1) {
    document.getElementById('algexprulesb2').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algexprules2') == 0) {
    document.getElementById('algexprulesb2').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algexprules3') == 1) {
  document.getElementById('algexprulesb3').style.background = '#7fff00';
}
  else if (localStorage.getItem('algexprules3') == 0) {
  document.getElementById('algexprulesb3').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algexprules4') == 1) {
  document.getElementById('algexprulesb4').style.background = '#7fff00';
}
  else if (localStorage.getItem('algexprules4') == 0) {
  document.getElementById('algexprulesb4').style.background = 'red';
  }
  else {
  ...
  if (localStorage.getItem('algexprules5') == 1) {
    document.getElementById('algexprulesb5').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algexprules5') == 0) {
    document.getElementById('algexprulesb5').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algexprules6') == 1) {
  document.getElementById('algexprulesb6').style.background = '#7fff00';
}
  else if (localStorage.getItem('algexprules6') == 0) {
  document.getElementById('algexprulesb6').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algexprules7') == 1) {
  document.getElementById('algexprulesb7').style.background = '#7fff00';
}
  else if (localStorage.getItem('algexprules7') == 0) {
  document.getElementById('algexprulesb7').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algexprules8') == 1) {
  document.getElementById('algexprulesb8').style.background = '#7fff00';
}
  else if (localStorage.getItem('algexprules8') == 0) {
  document.getElementById('algexprulesb8').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algexprules9') == 1) {
  document.getElementById('algexprulesb9').style.background = '#7fff00';
}
  else if (localStorage.getItem('algexprules9') == 0) {
  document.getElementById('algexprulesb9').style.background = 'red';
  }
  else {
