    ...
    if (document.getElementById('sa-algexprules-8') != null) {
      algexprules8But.onclick = function() {
        if (document.getElementById('o-algexprules-81').checked) {
          ...
          document.getElementById('r-algexprules-83').style.color = 'blue'
          document.getElementById('r-algexprules-83').innerHTML = 'Correct!'
          
          document.getElementById('b-algexprules-83').classList.add("correct")
          document.getElementById('b-algexprules-81').classList.add("incorrect")
          document.getElementById('b-algexprules-82').classList.add("incorrect")
        ...
        if (document.getElementById('o-algexprules-82').checked) {
          document.getElementById('r-algexprules-82').style.color = 'red'
          document.getElementById('r-algexprules-82').innerHTML = 'Incorrect!'
          document.getElementById('r-algexprules-83').style.color = 'blue'
          document.getElementById('r-algexprules-83').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algexprules-10') != null) {
      algexprules10But.onclick = function() {
        if (document.getElementById('o-algexprules-101').checked) {
          ...
          document.getElementById('r-algexprules-103').style.color = 'blue'
          document.getElementById('r-algexprules-103').innerHTML = 'Correct!'
          
          document.getElementById('b-algexprules-103').classList.add("correct")
          document.getElementById('b-algexprules-101').classList.add("incorrect")
          document.getElementById('b-algexprules-102').classList.add("incorrect")
        ...
        if (document.getElementById('o-algexprules-102').checked) {
          document.getElementById('r-algexprules-102').style.color = 'red'
          document.getElementById('r-algexprules-102').innerHTML = 'Incorrect!'
          document.getElementById('r-algexprules-103').style.color = 'blue'
          document.getElementById('r-algexprules-103').innerHTML = 'Correct!'
