    ...
    if (document.getElementById('sa-algcomnum-3') != null) {
      algcomnum3But.onclick = function() {
        if (document.getElementById('o-algcomnum-31').checked) {
          ...
          document.getElementById('r-algcomnum-34').style.color = 'blue'
          document.getElementById('r-algcomnum-34').innerHTML = 'Correct!'
          
          document.getElementById('b-algcomnum-34').classList.add("correct")
          ...
          document.getElementById('b-algcomnum-32').classList.add("incorrect")
        ...
        if (document.getElementById('o-algcomnum-32').checked) {
          document.getElementById('r-algcomnum-32').style.color = 'red'
          document.getElementById('r-algcomnum-32').innerHTML = 'Incorrect!'
          document.getElementById('r-algcomnum-34').style.color = 'blue'
          document.getElementById('r-algcomnum-34').innerHTML = 'Correct!'
