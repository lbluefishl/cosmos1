...
if (localStorage.getItem('algexpvslin1') == 1) {
  document.getElementById('algexpvslinb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpvslin1') == 0) {
  document.getElementById('algexpvslinb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpvslin2') == 1) {
    document.getElementById('algexpvslinb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algexpvslin2') == 0) {
    document.getElementById('algexpvslinb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algexpvslin3') == 1) {
  document.getElementById('algexpvslinb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpvslin3') == 0) {
  document.getElementById('algexpvslinb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpvslin4') == 1) {
  document.getElementById('algexpvslinb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpvslin4') == 0) {
  document.getElementById('algexpvslinb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('algexpvslin5') == 1) {
    document.getElementById('algexpvslinb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algexpvslin5') == 0) {
    document.getElementById('algexpvslinb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algexpvslin6') == 1) {
  document.getElementById('algexpvslinb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpvslin6') == 0) {
  document.getElementById('algexpvslinb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpvslin7') == 1) {
  document.getElementById('algexpvslinb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpvslin7') == 0) {
  document.getElementById('algexpvslinb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpvslin8') == 1) {
  document.getElementById('algexpvslinb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpvslin8') == 0) {
  document.getElementById('algexpvslinb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpvslin9') == 1) {
  document.getElementById('algexpvslinb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpvslin9') == 0) {
  document.getElementById('algexpvslinb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algexpvslin10') == 1) {
  document.getElementById('algexpvslinb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algexpvslin10') == 0) {
  document.getElementById('algexpvslinb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
