    ...
    if (document.getElementById('sa-algineq-2') != null) {
      algineq2But.onclick = function() {
        if (document.getElementById('o-algineq-21').checked) {
          document.getElementById('r-algineq-21').style.color = 'red'
          document.getElementById('r-algineq-21').innerHTML = 'Incorrect!'
          document.getElementById('r-algineq-23').style.color = 'blue'
          document.getElementById('r-algineq-23').innerHTML = 'Correct!'
          
          document.getElementById('b-algineq-23').classList.add("correct")
          document.getElementById('b-algineq-21').classList.add("incorrect")
    ...
    if (document.getElementById('sa-algineq-5') != null) {
      algineq5But.onclick = function() {
        if (document.getElementById('o-algineq-51').checked) {
          ...
          document.getElementById('r-algineq-53').style.color = 'blue'
          document.getElementById('r-algineq-53').innerHTML = 'Correct!'
          
          document.getElementById('b-algineq-53').classList.add("correct")
          document.getElementById('b-algineq-51').classList.add("incorrect")
          document.getElementById('b-algineq-52').classList.add("incorrect")
          document.getElementById('b-algineq-54').classList.add("incorrect")
        ...
        if (document.getElementById('o-algineq-54').checked) {
          document.getElementById('r-algineq-54').style.color = 'red'
          document.getElementById('r-algineq-54').innerHTML = 'Incorrect!'
          document.getElementById('r-algineq-53').style.color = 'blue'
          document.getElementById('r-algineq-53').innerHTML = 'Correct!'
      ...
      algineq6But.onclick = function() {
        if (document.getElementById('o-algineq-61').checked) {
          ...
          document.getElementById('r-algineq-64').style.color = 'blue'
          document.getElementById('r-algineq-64').innerHTML = 'Correct!'
          
          document.getElementById('b-algineq-64').classList.add("correct")
          document.getElementById('b-algineq-61').classList.add("incorrect")
          document.getElementById('b-algineq-62').classList.add("incorrect")
          document.getElementById('b-algineq-63').classList.add("incorrect")
        ...
        if (document.getElementById('o-algineq-63').checked) {
          document.getElementById('r-algineq-63').style.color = 'red'
          document.getElementById('r-algineq-63').innerHTML = 'Incorrect!'
          document.getElementById('r-algineq-64').style.color = 'blue'
          document.getElementById('r-algineq-64').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algineq-9') != null) {
      algineq9But.onclick = function() {
        if (document.getElementById('o-algineq-91').checked) {
          ...
          document.getElementById('r-algineq-94').style.color = 'blue'
          document.getElementById('r-algineq-94').innerHTML = 'Correct!'
          
          document.getElementById('b-algineq-94').classList.add("correct")
          document.getElementById('b-algineq-91').classList.add("incorrect")
          document.getElementById('b-algineq-92').classList.add("incorrect")
          document.getElementById('b-algineq-93').classList.add("incorrect")
