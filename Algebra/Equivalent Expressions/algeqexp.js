    ...
    if (document.getElementById('sa-algeqexp-5') != null) {
      ...
      algeqexp6But.onclick = function() {
        if (document.getElementById('o-algeqexp-61').checked) {
          ...
          document.getElementById('r-algeqexp-62').style.color = 'blue'
          document.getElementById('r-algeqexp-62').innerHTML = 'Correct!'
          
          document.getElementById('b-algeqexp-62').classList.add("correct")
          document.getElementById('b-algeqexp-61').classList.add("incorrect")
          document.getElementById('b-algeqexp-64').classList.add("incorrect")
        ...
        if (document.getElementById('o-algeqexp-64').checked) {
          document.getElementById('r-algeqexp-64').style.color = 'red'
          document.getElementById('r-algeqexp-64').innerHTML = 'Incorrect!'
          document.getElementById('r-algeqexp-62').style.color = 'blue'
          document.getElementById('r-algeqexp-62').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algeqexp-7') != null) {
      algeqexp7But.onclick = function() {
        if (document.getElementById('o-algeqexp-71').checked) {
          document.getElementById('r-algeqexp-71').style.color = 'blue'
          document.getElementById('r-algeqexp-71').innerHTML = 'Correct!'
          
          document.getElementById('b-algeqexp-71').classList.add("correct")
          document.getElementById('b-algeqexp-74').classList.add("incorrect")
        ...
        if (document.getElementById('o-algeqexp-74').checked) {
          document.getElementById('r-algeqexp-74').style.color = 'red'
          document.getElementById('r-algeqexp-74').innerHTML = 'Incorrect!'
          document.getElementById('r-algeqexp-71').style.color = 'blue'
          document.getElementById('r-algeqexp-71').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algeqexp-8') != null) {
      algeqexp8But.onclick = function() {
        if (document.getElementById('o-algeqexp-81').checked) {
          ...
          document.getElementById('r-algeqexp-83').style.color = 'blue'
          document.getElementById('r-algeqexp-83').innerHTML = 'Correct!'
          
          document.getElementById('b-algeqexp-83').classList.add("correct")
          document.getElementById('b-algeqexp-81').classList.add("incorrect")
          document.getElementById('b-algeqexp-82').classList.add("incorrect")
        ...
        if (document.getElementById('o-algeqexp-82').checked) {
          document.getElementById('r-algeqexp-82').style.color = 'red'
          document.getElementById('r-algeqexp-82').innerHTML = 'Incorrect!'
          document.getElementById('r-algeqexp-83').style.color = 'blue'
          document.getElementById('r-algeqexp-83').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algeqexp-10') != null) {
      algeqexp10But.onclick = function() {
        if (document.getElementById('o-algeqexp-101').checked) {
          ...
          document.getElementById('r-algeqexp-104').style.color = 'blue'
          document.getElementById('r-algeqexp-104').innerHTML = 'Correct!'
          
          document.getElementById('b-algeqexp-104').classList.add("correct")
          ...
          document.getElementById('b-algeqexp-102').classList.add("incorrect")
        ...
        if (document.getElementById('o-algeqexp-102').checked) {
          document.getElementById('r-algeqexp-102').style.color = 'red'
          document.getElementById('r-algeqexp-102').innerHTML = 'Incorrect!'
          document.getElementById('r-algeqexp-104').style.color = 'blue'
          document.getElementById('r-algeqexp-104').innerHTML = 'Correct!'
