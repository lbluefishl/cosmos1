    ...
    if (document.getElementById('sa-algmode-4') != null) {
      algmode4But.onclick = function() {
        if (document.getElementById('o-algmode-41').checked) {
          document.getElementById('r-algmode-41').style.color = 'blue'
          document.getElementById('r-algmode-41').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-41').classList.add("correct")
    ...
    if (document.getElementById('sa-algmode-5') != null) {
      algmode5But.onclick = function() {
        if (document.getElementById('o-algmode-51').checked) {
          ...
          document.getElementById('r-algmode-54').style.color = 'blue'
          document.getElementById('r-algmode-54').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-54').classList.add("correct")
          document.getElementById('b-algmode-51').classList.add("incorrect")
          document.getElementById('b-algmode-52').classList.add("incorrect")
          document.getElementById('b-algmode-53').classList.add("incorrect")
        ...
        if (document.getElementById('o-algmode-53').checked) {
          document.getElementById('r-algmode-53').style.color = 'red'
          document.getElementById('r-algmode-53').innerHTML = 'Incorrect!'
          document.getElementById('r-algmode-54').style.color = 'blue'
          document.getElementById('r-algmode-54').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algmode-8') != null) {
      algmode8But.onclick = function() {
        if (document.getElementById('o-algmode-81').checked) {
          document.getElementById('r-algmode-81').style.color = 'blue'
          document.getElementById('r-algmode-81').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-81').classList.add("correct")
    ...
    if (document.getElementById('sa-algmode-9') != null) {
      algmode9But.onclick = function() {
        if (document.getElementById('o-algmode-91').checked) {
          ...
          document.getElementById('r-algmode-93').style.color = 'blue'
          document.getElementById('r-algmode-93').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-93').classList.add("correct")
          document.getElementById('b-algmode-91').classList.add("incorrect")
          document.getElementById('b-algmode-92').classList.add("incorrect")
          document.getElementById('b-algmode-94').classList.add("incorrect")
        ...
        if (document.getElementById('o-algmode-92').checked) {
          document.getElementById('r-algmode-92').style.color = 'red'
          document.getElementById('r-algmode-92').innerHTML = 'Incorrect!'
          document.getElementById('r-algmode-93').style.color = 'blue'
          document.getElementById('r-algmode-93').innerHTML = 'Correct!'
        ...
        if (document.getElementById('o-algmode-94').checked) {
          document.getElementById('r-algmode-94').style.color = 'red'
          document.getElementById('r-algmode-94').innerHTML = 'Incorrect!'
          document.getElementById('r-algmode-93').style.color = 'blue'
          document.getElementById('r-algmode-93').innerHTML = 'Correct!'
