    ...
    if (document.getElementById('sa-algmode-2') != null) {
      algmode2But.onclick = function() {
        if (document.getElementById('o-algmode-21').checked) {
          ...
          document.getElementById('r-algmode-23').style.color = 'blue'
          document.getElementById('r-algmode-23').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-23').classList.add("correct")
        ...
        if (document.getElementById('o-algmode-22').checked) {
          document.getElementById('r-algmode-22').style.color = 'red'
          document.getElementById('r-algmode-22').innerHTML = 'Incorrect!'
          document.getElementById('r-algmode-23').style.color = 'blue'
          document.getElementById('r-algmode-23').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algmode-3') != null) {
      algmode3But.onclick = function() {
        if (document.getElementById('o-algmode-31').checked) {
          ...
          document.getElementById('r-algmode-32').style.color = 'blue'
          document.getElementById('r-algmode-32').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-32').classList.add("correct")
          document.getElementById('b-algmode-31').classList.add("incorrect")
          document.getElementById('b-algmode-33').classList.add("incorrect")
        ...
        if (document.getElementById('o-algmode-33').checked) {
          document.getElementById('r-algmode-33').style.color = 'red'
          document.getElementById('r-algmode-33').innerHTML = 'Incorrect!'
          document.getElementById('r-algmode-32').style.color = 'blue'
          document.getElementById('r-algmode-32').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algmode-4') != null) {
      algmode4But.onclick = function() {
        if (document.getElementById('o-algmode-41').checked) {
          ...
          document.getElementById('r-algmode-44').style.color = 'blue'
          document.getElementById('r-algmode-44').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-44').classList.add("correct")
          document.getElementById('b-algmode-41').classList.add("incorrect")
          document.getElementById('b-algmode-42').classList.add("incorrect")
          document.getElementById('b-algmode-43').classList.add("incorrect")
        ...
        if (document.getElementById('o-algmode-43').checked) {
          document.getElementById('r-algmode-43').style.color = 'red'
          document.getElementById('r-algmode-43').innerHTML = 'Incorrect!'
          document.getElementById('r-algmode-44').style.color = 'blue'
          document.getElementById('r-algmode-44').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algmode-5') != null) {
      ...
      algmode6But.onclick = function() {
        if (document.getElementById('o-algmode-61').checked) {
          document.getElementById('r-algmode-61').style.color = 'red'
          document.getElementById('r-algmode-61').innerHTML = 'Incorrect!'
          document.getElementById('r-algmode-64').style.color = 'blue'
          document.getElementById('r-algmode-64').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-64').classList.add("correct")
          document.getElementById('b-algmode-61').classList.add("incorrect")
    ...
    if (document.getElementById('sa-algmode-7') != null) {
      algmode7But.onclick = function() {
        if (document.getElementById('o-algmode-71').checked) {
          ...
          document.getElementById('r-algmode-74').style.color = 'blue'
          document.getElementById('r-algmode-74').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-74').classList.add("correct")
          document.getElementById('b-algmode-71').classList.add("incorrect")
          document.getElementById('b-algmode-72').classList.add("incorrect")
          document.getElementById('b-algmode-73').classList.add("incorrect")
        ...
        if (document.getElementById('o-algmode-73').checked) {
          document.getElementById('r-algmode-73').style.color = 'red'
          document.getElementById('r-algmode-73').innerHTML = 'Incorrect!'
          document.getElementById('r-algmode-74').style.color = 'blue'
          document.getElementById('r-algmode-74').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algmode-8') != null) {
      algmode8But.onclick = function() {
        if (document.getElementById('o-algmode-81').checked) {
          ...
          document.getElementById('r-algmode-82').style.color = 'blue'
          document.getElementById('r-algmode-82').innerHTML = 'Correct!'
          
          document.getElementById('b-algmode-82').classList.add("correct")
          document.getElementById('b-algmode-81').classList.add("incorrect")
          document.getElementById('b-algmode-83').classList.add("incorrect")
        ...
        if (document.getElementById('o-algmode-83').checked) {
          document.getElementById('r-algmode-83').style.color = 'red'
          document.getElementById('r-algmode-83').innerHTML = 'Incorrect!'
          document.getElementById('r-algmode-82').style.color = 'blue'
          document.getElementById('r-algmode-82').innerHTML = 'Correct!'
