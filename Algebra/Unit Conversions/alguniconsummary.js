...
if (localStorage.getItem('algunicon1') == 1) {
  document.getElementById('alguniconb1').style.background = '#7fff00';
}
  else if (localStorage.getItem('algunicon1') == 0) {
  document.getElementById('alguniconb1').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algunicon2') == 1) {
    document.getElementById('alguniconb2').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algunicon2') == 0) {
    document.getElementById('alguniconb2').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algunicon3') == 1) {
  document.getElementById('alguniconb3').style.background = '#7fff00';
}
  else if (localStorage.getItem('algunicon3') == 0) {
  document.getElementById('alguniconb3').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algunicon4') == 1) {
  document.getElementById('alguniconb4').style.background = '#7fff00';
}
  else if (localStorage.getItem('algunicon4') == 0) {
  document.getElementById('alguniconb4').style.background = 'red';
  }
  else {
  ...
  if (localStorage.getItem('algunicon5') == 1) {
    document.getElementById('alguniconb5').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algunicon5') == 0) {
    document.getElementById('alguniconb5').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algunicon6') == 1) {
  document.getElementById('alguniconb6').style.background = '#7fff00';
}
  else if (localStorage.getItem('algunicon6') == 0) {
  document.getElementById('alguniconb6').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algunicon7') == 1) {
  document.getElementById('alguniconb7').style.background = '#7fff00';
}
  else if (localStorage.getItem('algunicon7') == 0) {
  document.getElementById('alguniconb7').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algunicon8') == 1) {
  document.getElementById('alguniconb8').style.background = '#7fff00';
}
  else if (localStorage.getItem('algunicon8') == 0) {
  document.getElementById('alguniconb8').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algunicon9') == 1) {
  document.getElementById('alguniconb9').style.background = '#7fff00';
}
  else if (localStorage.getItem('algunicon9') == 0) {
  document.getElementById('alguniconb9').style.background = 'red';
  }
  else {
