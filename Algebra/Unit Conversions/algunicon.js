    ...
    if (document.getElementById('sa-algunicon-2') != null) {
      algunicon2But.onclick = function() {
        if (document.getElementById('o-algunicon-21').checked) {
          ...
          document.getElementById('r-algunicon-23').style.color = 'blue'
          document.getElementById('r-algunicon-23').innerHTML = 'Correct!'
          
          document.getElementById('b-algunicon-23').classList.add("correct")
          document.getElementById('b-algunicon-21').classList.add("incorrect")
          document.getElementById('b-algunicon-22').classList.add("incorrect")
        ...
        if (document.getElementById('o-algunicon-24').checked) {
          document.getElementById('r-algunicon-24').style.color = 'red'
          document.getElementById('r-algunicon-24').innerHTML = 'Incorrect!'
          document.getElementById('r-algunicon-23').style.color = 'blue'
          document.getElementById('r-algunicon-23').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algunicon-3') != null) {
      algunicon3But.onclick = function() {
        if (document.getElementById('o-algunicon-31').checked) {
          ...
          document.getElementById('r-algunicon-32').style.color = 'blue'
          document.getElementById('r-algunicon-32').innerHTML = 'Correct!'
          
          document.getElementById('b-algunicon-32').classList.add("correct")
          ...
          document.getElementById('b-algunicon-34').classList.add("incorrect")
        ...
        if (document.getElementById('o-algunicon-34').checked) {
          document.getElementById('r-algunicon-34').style.color = 'red'
          document.getElementById('r-algunicon-34').innerHTML = 'Incorrect!'
          document.getElementById('r-algunicon-32').style.color = 'blue'
          document.getElementById('r-algunicon-32').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algunicon-4') != null) {
      algunicon4But.onclick = function() {
        if (document.getElementById('o-algunicon-41').checked) {
          ...
          document.getElementById('r-algunicon-44').style.color = 'blue'
          document.getElementById('r-algunicon-44').innerHTML = 'Correct!'
          
          document.getElementById('b-algunicon-44').classList.add("correct")
          ...
          document.getElementById('b-algunicon-43').classList.add("incorrect")
        ...
        if (document.getElementById('o-algunicon-43').checked) {
          document.getElementById('r-algunicon-43').style.color = 'red'
          document.getElementById('r-algunicon-43').innerHTML = 'Incorrect!'
          document.getElementById('r-algunicon-44').style.color = 'blue'
          document.getElementById('r-algunicon-44').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algunicon-5') != null) {
      ...
      algunicon6But.onclick = function() {
        if (document.getElementById('o-algunicon-61').checked) {
          ...
          document.getElementById('r-algunicon-64').style.color = 'blue'
          document.getElementById('r-algunicon-64').innerHTML = 'Correct!'
          
          document.getElementById('b-algunicon-64').classList.add("correct")
          ...
          document.getElementById('b-algunicon-63').classList.add("incorrect")
        ...
        if (document.getElementById('o-algunicon-63').checked) {
          document.getElementById('r-algunicon-63').style.color = 'red'
          document.getElementById('r-algunicon-63').innerHTML = 'Incorrect!'
          document.getElementById('r-algunicon-64').style.color = 'blue'
          document.getElementById('r-algunicon-64').innerHTML = 'Correct!'
