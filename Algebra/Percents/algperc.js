    ...
    if (document.getElementById('sa-algperc-5') != null) {
      algperc5But.onclick = function() {
        if (document.getElementById('o-algperc-51').checked) {
          ...
          document.getElementById('r-algperc-53').style.color = 'blue'
          document.getElementById('r-algperc-53').innerHTML = 'Correct!'
          
          document.getElementById('b-algperc-53').classList.add("correct")
          document.getElementById('b-algperc-51').classList.add("incorrect")
          document.getElementById('b-algperc-52').classList.add("incorrect")
        ...
        if (document.getElementById('o-algperc-52').checked) {
          document.getElementById('r-algperc-52').style.color = 'red'
          document.getElementById('r-algperc-52').innerHTML = 'Incorrect!'
          document.getElementById('r-algperc-53').style.color = 'blue'
          document.getElementById('r-algperc-53').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algperc-7') != null) {
      algperc7But.onclick = function() {
        if (document.getElementById('o-algperc-71').checked) {
          ...
          document.getElementById('r-algperc-74').style.color = 'blue'
          document.getElementById('r-algperc-74').innerHTML = 'Correct!'
          
          document.getElementById('b-algperc-74').classList.add("correct")
          document.getElementById('b-algperc-71').classList.add("incorrect")
          document.getElementById('b-algperc-72').classList.add("incorrect")
        ...
        if (document.getElementById('o-algperc-72').checked) {
          document.getElementById('r-algperc-72').style.color = 'red'
          document.getElementById('r-algperc-72').innerHTML = 'Incorrect!'
          document.getElementById('r-algperc-74').style.color = 'blue'
          document.getElementById('r-algperc-74').innerHTML = 'Correct!'
