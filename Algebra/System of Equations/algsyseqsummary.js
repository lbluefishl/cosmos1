...
if (localStorage.getItem('algsyseq1') == 1) {
  document.getElementById('algsyseqb1').style.background = '#7fff00';
}
  else if (localStorage.getItem('algsyseq1') == 0) {
  document.getElementById('algsyseqb1').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algsyseq2') == 1) {
    document.getElementById('algsyseqb2').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algsyseq2') == 0) {
    document.getElementById('algsyseqb2').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algsyseq3') == 1) {
  document.getElementById('algsyseqb3').style.background = '#7fff00';
}
  else if (localStorage.getItem('algsyseq3') == 0) {
  document.getElementById('algsyseqb3').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algsyseq4') == 1) {
  document.getElementById('algsyseqb4').style.background = '#7fff00';
}
  else if (localStorage.getItem('algsyseq4') == 0) {
  document.getElementById('algsyseqb4').style.background = 'red';
  }
  else {
  ...
  if (localStorage.getItem('algsyseq5') == 1) {
    document.getElementById('algsyseqb5').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algsyseq5') == 0) {
    document.getElementById('algsyseqb5').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algsyseq6') == 1) {
  document.getElementById('algsyseqb6').style.background = '#7fff00';
}
  else if (localStorage.getItem('algsyseq6') == 0) {
  document.getElementById('algsyseqb6').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algsyseq7') == 1) {
  document.getElementById('algsyseqb7').style.background = '#7fff00';
}
  else if (localStorage.getItem('algsyseq7') == 0) {
  document.getElementById('algsyseqb7').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algsyseq8') == 1) {
  document.getElementById('algsyseqb8').style.background = '#7fff00';
}
  else if (localStorage.getItem('algsyseq8') == 0) {
  document.getElementById('algsyseqb8').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algsyseq9') == 1) {
  document.getElementById('algsyseqb9').style.background = '#7fff00';
}
  else if (localStorage.getItem('algsyseq9') == 0) {
  document.getElementById('algsyseqb9').style.background = 'red';
  }
  else {
