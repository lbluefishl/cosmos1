...
if (document.getElementById('sa-algsimeq-9') != null) {
  algsimeq9But.onclick = function () {
    if (document.getElementById('o-algsimeq-91').checked) {
      ...
      document.getElementById('r-algsimeq-94').style.color = 'blue'
      document.getElementById('r-algsimeq-94').innerHTML = 'Correct!'

      document.getElementById('b-algsimeq-94').classList.add("correct")
      document.getElementById('b-algsimeq-91').classList.add("incorrect")
...
if (document.getElementById('sa-algsimeq-10') != null) {
  algsimeq10But.onclick = function () {
    if (document.getElementById('o-algsimeq-101').checked) {
      ...
      document.getElementById('r-algsimeq-102').style.color = 'blue'
      document.getElementById('r-algsimeq-102').innerHTML = 'Correct!'

      document.getElementById('b-algsimeq-102').classList.add("correct")
      document.getElementById('b-algsimeq-101').classList.add("incorrect")
      document.getElementById('b-algsimeq-103').classList.add("incorrect")
