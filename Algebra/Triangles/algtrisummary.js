...
if (localStorage.getItem('algtri1') == 1) {
  document.getElementById('algtrib1').style.background = '#7fff00';
}
  else if (localStorage.getItem('algtri1') == 0) {
  document.getElementById('algtrib1').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algtri2') == 1) {
    document.getElementById('algtrib2').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algtri2') == 0) {
    document.getElementById('algtrib2').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algtri3') == 1) {
  document.getElementById('algtrib3').style.background = '#7fff00';
}
  else if (localStorage.getItem('algtri3') == 0) {
  document.getElementById('algtrib3').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algtri4') == 1) {
  document.getElementById('algtrib4').style.background = '#7fff00';
}
  else if (localStorage.getItem('algtri4') == 0) {
  document.getElementById('algtrib4').style.background = 'red';
  }
  else {
  ...
  if (localStorage.getItem('algtri5') == 1) {
    document.getElementById('algtrib5').style.background = '#7fff00';
  }
    else if (localStorage.getItem('algtri5') == 0) {
    document.getElementById('algtrib5').style.background = 'red';
    }
    else {
...
if (localStorage.getItem('algtri6') == 1) {
  document.getElementById('algtrib6').style.background = '#7fff00';
}
  else if (localStorage.getItem('algtri6') == 0) {
  document.getElementById('algtrib6').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algtri7') == 1) {
  document.getElementById('algtrib7').style.background = '#7fff00';
}
  else if (localStorage.getItem('algtri7') == 0) {
  document.getElementById('algtrib7').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algtri8') == 1) {
  document.getElementById('algtrib8').style.background = '#7fff00';
}
  else if (localStorage.getItem('algtri8') == 0) {
  document.getElementById('algtrib8').style.background = 'red';
  }
  else {
...
if (localStorage.getItem('algtri9') == 1) {
  document.getElementById('algtrib9').style.background = '#7fff00';
}
  else if (localStorage.getItem('algtri9') == 0) {
  document.getElementById('algtrib9').style.background = 'red';
  }
  else {
