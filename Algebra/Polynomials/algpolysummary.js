...
if (localStorage.getItem('algpoly1') == 1) {
  document.getElementById('algpolyb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algpoly1') == 0) {
  document.getElementById('algpolyb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algpoly2') == 1) {
    document.getElementById('algpolyb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algpoly2') == 0) {
    document.getElementById('algpolyb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algpoly3') == 1) {
  document.getElementById('algpolyb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algpoly3') == 0) {
  document.getElementById('algpolyb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algpoly4') == 1) {
  document.getElementById('algpolyb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algpoly4') == 0) {
  document.getElementById('algpolyb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('algpoly5') == 1) {
    document.getElementById('algpolyb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algpoly5') == 0) {
    document.getElementById('algpolyb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algpoly6') == 1) {
  document.getElementById('algpolyb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algpoly6') == 0) {
  document.getElementById('algpolyb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algpoly7') == 1) {
  document.getElementById('algpolyb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algpoly7') == 0) {
  document.getElementById('algpolyb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algpoly8') == 1) {
  document.getElementById('algpolyb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algpoly8') == 0) {
  document.getElementById('algpolyb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algpoly9') == 1) {
  document.getElementById('algpolyb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algpoly9') == 0) {
  document.getElementById('algpolyb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algpoly10') == 1) {
  document.getElementById('algpolyb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algpoly10') == 0) {
  document.getElementById('algpolyb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
