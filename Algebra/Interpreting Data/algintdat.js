    ...
    if (document.getElementById('sa-algintdat-2') != null) {
      algintdat2But.onclick = function() {
        if (document.getElementById('o-algintdat-21').checked) {
          ...
          document.getElementById('r-algintdat-23').style.color = 'blue'
          document.getElementById('r-algintdat-23').innerHTML = 'Correct!'
          
          document.getElementById('b-algintdat-23').classList.add("correct")
          document.getElementById('b-algintdat-21').classList.add("incorrect")
          document.getElementById('b-algintdat-22').classList.add("incorrect")
        ...
        if (document.getElementById('o-algintdat-24').checked) {
          document.getElementById('r-algintdat-24').style.color = 'red'
          document.getElementById('r-algintdat-24').innerHTML = 'Incorrect!'
          document.getElementById('r-algintdat-23').style.color = 'blue'
          document.getElementById('r-algintdat-23').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algintdat-4') != null) {
      algintdat4But.onclick = function() {
        if (document.getElementById('o-algintdat-41').checked) {
          ...
          document.getElementById('r-algintdat-44').style.color = 'blue'
          document.getElementById('r-algintdat-44').innerHTML = 'Correct!'
          
          document.getElementById('b-algintdat-44').classList.add("correct")
          ...
          document.getElementById('b-algintdat-43').classList.add("incorrect")
        ...
        if (document.getElementById('o-algintdat-43').checked) {
          document.getElementById('r-algintdat-43').style.color = 'red'
          document.getElementById('r-algintdat-43').innerHTML = 'Incorrect!'
          document.getElementById('r-algintdat-44').style.color = 'blue'
          document.getElementById('r-algintdat-44').innerHTML = 'Correct!'
