    ...
    if (document.getElementById('sa-algintdat-5') != null) {
      ...
      algintdat6But.onclick = function() {
        if (document.getElementById('o-algintdat-61').checked) {
          ...
          document.getElementById('r-algintdat-63').style.color = 'blue'
          document.getElementById('r-algintdat-63').innerHTML = 'Correct!'
          
          document.getElementById('b-algintdat-63').classList.add("correct")
          ...
          document.getElementById('b-algintdat-64').classList.add("incorrect")
        ...
        if (document.getElementById('o-algintdat-64').checked) {
          document.getElementById('r-algintdat-64').style.color = 'red'
          document.getElementById('r-algintdat-64').innerHTML = 'Incorrect!'
          document.getElementById('r-algintdat-63').style.color = 'blue'
          document.getElementById('r-algintdat-63').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algintdat-7') != null) {
      algintdat7But.onclick = function() {
        if (document.getElementById('o-algintdat-71').checked) {
          ...
          document.getElementById('r-algintdat-72').style.color = 'blue'
          document.getElementById('r-algintdat-72').innerHTML = 'Correct!'
          
          document.getElementById('b-algintdat-72').classList.add("correct")
          document.getElementById('b-algintdat-71').classList.add("incorrect")
          document.getElementById('b-algintdat-74').classList.add("incorrect")
        ...
        if (document.getElementById('o-algintdat-74').checked) {
          document.getElementById('r-algintdat-74').style.color = 'red'
          document.getElementById('r-algintdat-74').innerHTML = 'Incorrect!'
          document.getElementById('r-algintdat-72').style.color = 'blue'
          document.getElementById('r-algintdat-72').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algintdat-8') != null) {
      algintdat8But.onclick = function() {
        if (document.getElementById('o-algintdat-81').checked) {
          ...
          document.getElementById('r-algintdat-84').style.color = 'blue'
          document.getElementById('r-algintdat-84').innerHTML = 'Correct!'
          
          document.getElementById('b-algintdat-84').classList.add("correct")
          ...
          document.getElementById('b-algintdat-82').classList.add("incorrect")
        ...
        if (document.getElementById('o-algintdat-82').checked) {
          document.getElementById('r-algintdat-82').style.color = 'red'
          document.getElementById('r-algintdat-82').innerHTML = 'Incorrect!'
          document.getElementById('r-algintdat-84').style.color = 'blue'
          document.getElementById('r-algintdat-84').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algintdat-9') != null) {
      algintdat9But.onclick = function() {
        if (document.getElementById('o-algintdat-91').checked) {
          ...
          document.getElementById('r-algintdat-93').style.color = 'blue'
          document.getElementById('r-algintdat-93').innerHTML = 'Correct!'
          
          document.getElementById('b-algintdat-93').classList.add("correct")
          ...
          document.getElementById('b-algintdat-94').classList.add("incorrect")
        ...
        if (document.getElementById('o-algintdat-92').checked) {
          document.getElementById('r-algintdat-92').style.color = 'red'
          document.getElementById('r-algintdat-92').innerHTML = 'Incorrect!'
          document.getElementById('r-algintdat-93').style.color = 'blue'
          document.getElementById('r-algintdat-93').innerHTML = 'Correct!'
        ...
        if (document.getElementById('o-algintdat-94').checked) {
          document.getElementById('r-algintdat-94').style.color = 'red'
          document.getElementById('r-algintdat-94').innerHTML = 'Incorrect!'
          document.getElementById('r-algintdat-93').style.color = 'blue'
          document.getElementById('r-algintdat-93').innerHTML = 'Correct!'
