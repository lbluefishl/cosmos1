...
if (localStorage.getItem('algintdat1') == 1) {
  document.getElementById('algintdatb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algintdat1') == 0) {
  document.getElementById('algintdatb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algintdat2') == 1) {
    document.getElementById('algintdatb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algintdat2') == 0) {
    document.getElementById('algintdatb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algintdat3') == 1) {
  document.getElementById('algintdatb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algintdat3') == 0) {
  document.getElementById('algintdatb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algintdat4') == 1) {
  document.getElementById('algintdatb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algintdat4') == 0) {
  document.getElementById('algintdatb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('algintdat5') == 1) {
    document.getElementById('algintdatb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('algintdat5') == 0) {
    document.getElementById('algintdatb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('algintdat6') == 1) {
  document.getElementById('algintdatb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algintdat6') == 0) {
  document.getElementById('algintdatb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algintdat7') == 1) {
  document.getElementById('algintdatb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algintdat7') == 0) {
  document.getElementById('algintdatb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algintdat8') == 1) {
  document.getElementById('algintdatb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algintdat8') == 0) {
  document.getElementById('algintdatb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algintdat9') == 1) {
  document.getElementById('algintdatb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algintdat9') == 0) {
  document.getElementById('algintdatb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('algintdat10') == 1) {
  document.getElementById('algintdatb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('algintdat10') == 0) {
  document.getElementById('algintdatb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
