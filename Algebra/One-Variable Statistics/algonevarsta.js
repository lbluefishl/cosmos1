    ...
    if (document.getElementById('sa-algonevarsta-2') != null) {
      algonevarsta2But.onclick = function() {
        if (document.getElementById('o-algonevarsta-21').checked) {
          ...
          document.getElementById('r-algonevarsta-23').style.color = 'blue'
          document.getElementById('r-algonevarsta-23').innerHTML = 'Correct!'
          
          document.getElementById('b-algonevarsta-23').classList.add("correct")
          document.getElementById('b-algonevarsta-21').classList.add("incorrect")
          document.getElementById('b-algonevarsta-22').classList.add("incorrect")
        ...
        if (document.getElementById('o-algonevarsta-22').checked) {
          document.getElementById('r-algonevarsta-22').style.color = 'red'
          document.getElementById('r-algonevarsta-22').innerHTML = 'Incorrect!'
          document.getElementById('r-algonevarsta-23').style.color = 'blue'
          document.getElementById('r-algonevarsta-23').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algonevarsta-3') != null) {
      algonevarsta3But.onclick = function() {
        if (document.getElementById('o-algonevarsta-31').checked) {
          ...
          document.getElementById('r-algonevarsta-32').style.color = 'blue'
          document.getElementById('r-algonevarsta-32').innerHTML = 'Correct!'
          
          document.getElementById('b-algonevarsta-32').classList.add("correct")
        ...
        if (document.getElementById('o-algonevarsta-33').checked) {
          document.getElementById('r-algonevarsta-33').style.color = 'red'
          document.getElementById('r-algonevarsta-33').innerHTML = 'Incorrect!'
          document.getElementById('r-algonevarsta-32').style.color = 'blue'
          document.getElementById('r-algonevarsta-32').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algonevarsta-4') != null) {
      algonevarsta4But.onclick = function() {
        if (document.getElementById('o-algonevarsta-41').checked) {
          document.getElementById('r-algonevarsta-41').style.color = 'red'
          document.getElementById('r-algonevarsta-41').innerHTML = 'Incorrect!'
          document.getElementById('r-algonevarsta-44').style.color = 'blue'
          document.getElementById('r-algonevarsta-44').innerHTML = 'Correct!'
          
          document.getElementById('b-algonevarsta-44').classList.add("correct")
          document.getElementById('b-algonevarsta-41').classList.add("incorrect")
    ...
    if (document.getElementById('sa-algonevarsta-5') != null) {
      algonevarsta5But.onclick = function() {
        if (document.getElementById('o-algonevarsta-51').checked) {
          ...
          document.getElementById('r-algonevarsta-53').style.color = 'blue'
          document.getElementById('r-algonevarsta-53').innerHTML = 'Correct!'
          
          document.getElementById('b-algonevarsta-53').classList.add("correct")
        ...
        if (document.getElementById('o-algonevarsta-54').checked) {
          document.getElementById('r-algonevarsta-54').style.color = 'red'
          document.getElementById('r-algonevarsta-54').innerHTML = 'Incorrect!'
          document.getElementById('r-algonevarsta-53').style.color = 'blue'
          document.getElementById('r-algonevarsta-53').innerHTML = 'Correct!'
