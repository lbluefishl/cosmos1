    ...
    if (document.getElementById('sa-algonevarsta-5') != null) {
      ...
      algonevarsta6But.onclick = function() {
        if (document.getElementById('o-algonevarsta-61').checked) {
          ...
          document.getElementById('r-algonevarsta-63').style.color = 'blue'
          document.getElementById('r-algonevarsta-63').innerHTML = 'Correct!'
          
          document.getElementById('b-algonevarsta-63').classList.add("correct")
          ...
          document.getElementById('b-algonevarsta-64').classList.add("incorrect")
        ...
        if (document.getElementById('o-algonevarsta-64').checked) {
          document.getElementById('r-algonevarsta-64').style.color = 'red'
          document.getElementById('r-algonevarsta-64').innerHTML = 'Incorrect!'
          document.getElementById('r-algonevarsta-63').style.color = 'blue'
          document.getElementById('r-algonevarsta-63').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algonevarsta-7') != null) {
      algonevarsta7But.onclick = function() {
        if (document.getElementById('o-algonevarsta-71').checked) {
          document.getElementById('r-algonevarsta-71').style.color = 'blue'
          document.getElementById('r-algonevarsta-71').innerHTML = 'Correct!'
          
          document.getElementById('b-algonevarsta-71').classList.add("correct")
          document.getElementById('b-algonevarsta-74').classList.add("incorrect")
        ...
        if (document.getElementById('o-algonevarsta-74').checked) {
          document.getElementById('r-algonevarsta-74').style.color = 'red'
          document.getElementById('r-algonevarsta-74').innerHTML = 'Incorrect!'
          document.getElementById('r-algonevarsta-71').style.color = 'blue'
          document.getElementById('r-algonevarsta-71').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algonevarsta-9') != null) {
      algonevarsta9But.onclick = function() {
        if (document.getElementById('o-algonevarsta-91').checked) {
          ...
          document.getElementById('r-algonevarsta-92').style.color = 'blue'
          document.getElementById('r-algonevarsta-92').innerHTML = 'Correct!'
          
          document.getElementById('b-algonevarsta-92').classList.add("correct")
          document.getElementById('b-algonevarsta-91').classList.add("incorrect")
          document.getElementById('b-algonevarsta-94').classList.add("incorrect")
        ...
        if (document.getElementById('o-algonevarsta-93').checked) {
          document.getElementById('r-algonevarsta-93').style.color = 'red'
          document.getElementById('r-algonevarsta-93').innerHTML = 'Incorrect!'
          document.getElementById('r-algonevarsta-92').style.color = 'blue'
          document.getElementById('r-algonevarsta-92').innerHTML = 'Correct!'
        ...
        if (document.getElementById('o-algonevarsta-94').checked) {
          document.getElementById('r-algonevarsta-94').style.color = 'red'
          document.getElementById('r-algonevarsta-94').innerHTML = 'Incorrect!'
          document.getElementById('r-algonevarsta-92').style.color = 'blue'
          document.getElementById('r-algonevarsta-92').innerHTML = 'Correct!'
