    ...
    if (document.getElementById('sa-algabsval-2') != null) {
      algabsval2But.onclick = function() {
        if (document.getElementById('o-algabsval-21').checked) {
          ...
          document.getElementById('r-algabsval-24').style.color = 'blue'
          document.getElementById('r-algabsval-24').innerHTML = 'Correct!'
          
          document.getElementById('b-algabsval-24').classList.add("correct")
          ...
          document.getElementById('b-algabsval-23').classList.add("incorrect")
        ...
        if (document.getElementById('o-algabsval-23').checked) {
          document.getElementById('r-algabsval-23').style.color = 'red'
          document.getElementById('r-algabsval-23').innerHTML = 'Incorrect!'
          document.getElementById('r-algabsval-24').style.color = 'blue'
          document.getElementById('r-algabsval-24').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algabsval-3') != null) {
      algabsval3But.onclick = function() {
        if (document.getElementById('o-algabsval-31').checked) {
          document.getElementById('r-algabsval-31').style.color = 'blue'
          document.getElementById('r-algabsval-31').innerHTML = 'Correct!'
          
          document.getElementById('b-algabsval-31').classList.add("correct")
          document.getElementById('b-algabsval-32').classList.add("incorrect")
        ...
        if (document.getElementById('o-algabsval-32').checked) {   
          document.getElementById('r-algabsval-32').style.color = 'red'
          document.getElementById('r-algabsval-32').innerHTML = 'Incorrect!' 
          document.getElementById('r-algabsval-31').style.color = 'blue'
          document.getElementById('r-algabsval-31').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algabsval-4') != null) {
      algabsval4But.onclick = function() {
        if (document.getElementById('o-algabsval-41').checked) {
          document.getElementById('r-algabsval-41').style.color = 'blue'
          document.getElementById('r-algabsval-41').innerHTML = 'Correct!'
          
          document.getElementById('b-algabsval-41').classList.add("correct")
          document.getElementById('b-algabsval-44').classList.add("incorrect")
        ...
        if (document.getElementById('o-algabsval-44').checked) {
          document.getElementById('r-algabsval-44').style.color = 'red'
          document.getElementById('r-algabsval-44').innerHTML = 'Incorrect!'
          document.getElementById('r-algabsval-41').style.color = 'blue'
          document.getElementById('r-algabsval-41').innerHTML = 'Correct!'
    ...
    if (document.getElementById('sa-algabsval-5') != null) {
      algabsval5But.onclick = function() {
        if (document.getElementById('o-algabsval-51').checked) {
          ...
          document.getElementById('r-algabsval-54').style.color = 'blue'
          document.getElementById('r-algabsval-54').innerHTML = 'Correct!'
          
          document.getElementById('b-algabsval-54').classList.add("correct")
          ...
          document.getElementById('b-algabsval-53').classList.add("incorrect")
        ...
        if (document.getElementById('o-algabsval-53').checked) {
          document.getElementById('r-algabsval-53').style.color = 'red'
          document.getElementById('r-algabsval-53').innerHTML = 'Incorrect!'
          document.getElementById('r-algabsval-54').style.color = 'blue'
          document.getElementById('r-algabsval-54').innerHTML = 'Correct!'
