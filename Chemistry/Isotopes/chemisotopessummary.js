...
if (localStorage.getItem('chemisotopes1') == 1) {
  document.getElementById('chemisotopesb1').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('chemisotopes1') == 0) {
  document.getElementById('chemisotopesb1').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('chemisotopes2') == 1) {
    document.getElementById('chemisotopesb2').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('chemisotopes2') == 0) {
    document.getElementById('chemisotopesb2').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('chemisotopes3') == 1) {
  document.getElementById('chemisotopesb3').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('chemisotopes3') == 0) {
  document.getElementById('chemisotopesb3').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('chemisotopes4') == 1) {
  document.getElementById('chemisotopesb4').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('chemisotopes4') == 0) {
  document.getElementById('chemisotopesb4').style.background = 'rgb(255, 213, 128)';
  }
  else {
  ...
  if (localStorage.getItem('chemisotopes5') == 1) {
    document.getElementById('chemisotopesb5').style.background = 'rgb(181, 238, 238)';
  }
    else if (localStorage.getItem('chemisotopes5') == 0) {
    document.getElementById('chemisotopesb5').style.background = 'rgb(255, 213, 128)';
    }
    else {
...
if (localStorage.getItem('chemisotopes6') == 1) {
  document.getElementById('chemisotopesb6').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('chemisotopes6') == 0) {
  document.getElementById('chemisotopesb6').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('chemisotopes7') == 1) {
  document.getElementById('chemisotopesb7').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('chemisotopes7') == 0) {
  document.getElementById('chemisotopesb7').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('chemisotopes8') == 1) {
  document.getElementById('chemisotopesb8').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('chemisotopes8') == 0) {
  document.getElementById('chemisotopesb8').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('chemisotopes9') == 1) {
  document.getElementById('chemisotopesb9').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('chemisotopes9') == 0) {
  document.getElementById('chemisotopesb9').style.background = 'rgb(255, 213, 128)';
  }
  else {
...
if (localStorage.getItem('chemisotopes10') == 1) {
  document.getElementById('chemisotopesb10').style.background = 'rgb(181, 238, 238)';
}
  else if (localStorage.getItem('chemisotopes10') == 0) {
  document.getElementById('chemisotopesb10').style.background = 'rgb(255, 213, 128)';
  }
  else {
